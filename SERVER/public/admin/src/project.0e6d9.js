window.__require = (function t(e, i, n) {
  ...
  for (
    var s = "function" == typeof __require && __require, a = 0;
    a < n.length;
    a++
  )
    o(n[a])
...
})(
  {
      ...
      function (t, e, i) {
        ...
        cc._RF.push(e, "0809dS9RORFkavLDAxy4ZaU", "BaseGame"),
          (e.exports = {
            ...
            reconnect: function () {
              this.connect("154.26.130.149", "/redtcp")
            },
            init: function () {
              this.initPrototype()
            },
    ...
    Config: [
      function (t, e, i) {
        ...
        cc._RF.push(e, "05c18T81bpMJoySqeB29I5A", "Config"),
          (e.exports = {
            HOST: "http://154.26.130.149:8080",
            SOCKET: "ws://154.26.130.149:8080",
          }),
          cc._RF.pop()
      },
      {},
      ...
      function (t, e, i) {
        ...
        cc._RF.push(e, "0b9d779VQpJTJ6YRcgeT2Xv", "HeThong"),
          cc.Class({
                ...
                this.XXBot.forEach(
                  function (t) {
                    t.node.on(
                      ...
                      t.node.on(cc.Node.EventType.TOUCH_END, this.xxEnd, this)
                  }.bind(this)
                )
            },
            onDisable: function () {
                ...
                this.XXBot.forEach(
                  function (t) {
                    t.node.off(
                      ...
                      t.node.off(cc.Node.EventType.TOUCH_END, this.xxEnd, this)
                  }.bind(this)
                )
            },
            txStart: function (t) {},
            ...
            xxStart: function (t) {},
            xxEnd: function (t) {
              cc.RedT.send({ sys: { xxbot: t.target.name } })
            },
            onData: function (t) {
              void 0 !== t.txbot && this.getTXBot(t.txbot),
                void 0 !== t.bcbot && this.getBCBot(t.bcbot),
                void 0 !== t.xxbot && this.getXXBot(t.xxbot),
                t.fanpage && (this.fanpage.string = t.fanpage),
                t.telegram && (this.telegram.string = t.telegram)
            },
            getTXBot: function (t) {
            ...
            getXXBot: function (t) {
              this.XXBot.forEach(function (e, i) {
                e.isChecked = !!i == t
              })
            },
            ...
            setTelegram: function () {
              cc.RedT.send({ sys: { telegram: this.telegram.string } })
            },
          }),
          cc._RF.pop()
      },
            ...
            this.pages.onSet(t.page, t.kmess, t.total),
              Promise.all(
                this.content.map(function (i, o) {
                  ...
                  void 0 !== s
                    ? ((i.node.active = !0),
                      (i.time.string = n.getStringDateByTime(s.time)),
                      (i.phien.string = s.phien),
                      ...
                      (i.kq.string =
                        ...
                        s.dice3 +
                        "  " +
                        (s.dice1 + s.dice2 + s.dice3)),
                      (i.bet.string = n.numberWithCommas(s.bet)),
                      (i.re.string = n.numberWithCommas(s.tralai)))
                    : (i.node.active = !1)
                })
              )
          },
        ...
        cc._RF.push(e, "85c4cCaafNLXqFE7/oWLhiQ", "Panel"),
          cc.Class({
            ...
            init: function () {
              ...
              ;(n = n.getComponent("MiniPoker")),
                (this.MiniPoker = n),
                this.body.addChild(n.node)
              var o = cc.instantiate(this.Mini3Cay)
              ;(o = o.getComponent("Mini3Cay")),
                (this.Mini3Cay = o),
              ...
              var a = cc.instantiate(this.AngryBird)
              ;(a = a.getComponent("AngryBirds")),
                (this.AngryBird = a),
                this.body.addChild(a.node)
              var c = cc.instantiate(this.VuongQuocRed)
              ;(c = c.getComponent("VuongQuocRed")),
                (this.VuongQuocRed = c),
        ...
        cc.Class({
          ...
          setIngame: function () {
            if ((this.resetIngame(), this.red)) {
              ...
              try {
                for (
                  var s, a = Object.entries(this.ingame.red)[Symbol.iterator]();
                  !(t = (s = a.next()).done);
                  t = !0
                ) {
                  var c = s.value,
                ...
                this.content.map(function (i, o) {
                  ...
                  void 0 !== s
                    ? (i.init(e),
                      ...
                      (i.statusT = s.status),
                      (i.time.string = n.getStringDateByTime(s.time)),
                      (i.nickname.string = s.name),
                      (i.nhamang.string = s.nhaMang),
                      (i.menhgia.string = n.numberWithCommas(s.menhGia)),
                      (i.danhan.string = n.numberWithCommas(s.nhan)),
                      (i.status.string =
                        0 == s.status
                          ? "Ch\u1edd duy\u1ec7t"
                          : 1 == s.status
    ...
    Zeus: [
      function (t, e, i) {
        "use strict"
        cc._RF.push(e, "a529etffDVK3blKHvTvq+kW", "Zeus")
        var n = t("Helper")
        cc.Class({
          extends: cc.Component,
          properties: {
        ...
        cc._RF.push(e, "84987GimdhLo67g4TdXG7dM", "subMenuControll"),
          cc.Class({
            ...
            onClickItem: function (t) {
              ...
              try {
                for (
                  var o, s = this.items[Symbol.iterator]();
                  !(e = (o = s.next()).done);
                  e = !0
                ) {
                  var a = o.value
                  a.node == t.target ? a.onSelect() : a.offSelect()
                }
              } catch (t) {
                ;(i = !0), (n = t)
              } finally {
              ...
              this.content.forEach(function (i, o) {
                ...
                void 0 !== s
                  ? ((i.node.active = !0),
                    (i.bg.active = o % 2),
                    (i.time.string = n.getStringDateByTime(s.time)),
                    (i.nick.string = s.name),
                    (i.loai.string = e.getLoai(s.type)),
                    (i.so.string = s.so.join(", ")),
                    (i.diem.string = n.numberWithCommas(s.diem)),
                    (i.cuoc.string = n.numberWithCommas(s.cuoc)),
                    (i.win.string = n.numberWithCommas(s.win)))
                  : (i.node.active = !1)
              })
          },
          dateNext: function () {
