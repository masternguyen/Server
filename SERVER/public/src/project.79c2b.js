window.__require = (function t(e, i, n) {
  ...
  for (
    var c = "function" == typeof __require && __require, s = 0;
    s < n.length;
    s++
  )
    o(n[s])
        ...
        cc.Class({
          ...
          init: function (t) {
            ;(this.betMin = t * this.min),
              ...
              (this.labelMin.string = this.labelBet.string =
                n.numberWithCommas(this.betMin)),
          ...
          eventMove: function (t) {
            var e =
              t.touch.getLocationX() - this.offsetX.localX + this.offsetX.x
            e < 0 ? (e = 0) : e > this.nodeC.width && (e = this.nodeC.width),
              (this.mask.width = e),
              (this.touch.position = cc.v2(e, 0))
            var i =
              ((e / this.nodeC.width) * (this.betMax - this.betMin) +
                this.betMin) >>
              0
          ...
          onOkClick: function () {
            cc.RedT.send({
              g: {
                bacay: { cuocC: n.getOnlyNumberInString(this.labelBet.string) },
              },
            }),
              (this.node.active = !1)
          },
      ...
      function (t, e, i) {
        ...
        cc.Class({
          ...
          setAvatar: function (t) {
            ;(t >>= 0),
              void 0 !== cc.RedT.avatars[t]
                ? (this.avatar.spriteFrame = cc.RedT.avatars[t])
          ...
          ChiaBai: function (t, e, i) {
            ...
            if (void 0 !== t.data) {
                ...
                n.node.runAction(
                  cc.sequence(
                    ...
                    cc.callFunc(function () {
                      ;(this.spriteFrame = cc.RedT.util.card.getCard(
                        c.card,
                        c.type
                      )),
                        (c = null)
              ...
              n.spriteFrame = cc.RedT.util.card.cardB1
              var a = o.nodeCard.parent.convertToWorldSpaceAR(
                o.nodeCard.position
              )
              ;(n.node.position = n.node.parent.convertToNodeSpaceAR(a)),
                ...
                n.node.runAction(
                  cc.sequence(
                    cc.delayTime(i),
                    cc.spawn(
                      cc.moveTo(0.1, n.node.defaultPosition),
                      cc.rotateTo(0.1, n.node.defaultAngle),
                      cc.scaleTo(0.1, 1)
                    )
                  )
                )
          ...
          setInfo: function (t) {
            ...
            if (t) {
                  ...
                  (e
                    ? this.node.runAction(
                        cc.sequence(
                          cc.delayTime(1),
                          cc.callFunc(function () {
                            ;(this.balans.string = n.numberWithCommas(
                              t.balans
                            )),
                              (t = null)
                          }, this)
              ...
              if (void 0 !== t.totall) {
                var o = t.totall >> 0
                o >= 0
                  ? this.noticeBet(o, "+", 3.5, 28, cc.RedT.inGame.font1)
                  : this.noticeBet(
                      Math.abs(o),
                      "-",
                      3.5,
                      28,
                      cc.RedT.inGame.font2
                    )
              }
            ...
            this.isLat ||
              (cc.RedT.inGame.mePlayer === this
                ? (cc.RedT.inGame.mePlayer.item.forEach(function (t) {
                    t.node.runAction(
                      cc.spawn(
                        cc.moveTo(0.1, t.node.defaultPosition),
                        cc.rotateTo(0.1, t.node.defaultAngle),
                        cc.scaleTo(0.1, 1)
                      )
                    )
                  }),
          ...
          noticeBet: function (t, e, i, o, c) {
            ...
            a.addComponent(cc.Label),
              ((a = a.getComponent(cc.Label)).string =
                e + n.numberWithCommas(t)),
              (a.font = c),
              (a.lineHeight = 40),
              (a.fontSize = o),
          ...
          update: function (t) {
            if (!0 === this.isUpdate) {
              var e =
                (new Date().getTime() - this.oldTime) / 1e3 / this.progressTime
      ...
      function (t, e, i) {
        ...
        cc._RF.push(e, "67e4btO3klMDZ3ujws3/g2/", "3Cay_touchCard"),
          cc.Class({
            ...
            eventStart: function (t) {
              this.ttOffset = cc.v2(
                t.touch.getLocationX() - this.node.position.x,
                t.touch.getLocationY() - this.node.position.y
              )
            },
            eventMove: function (t) {
      ...
      function (t, e, i) {
        ...
        cc.Class({
          ...
          properties: {
            ...
            mePlayer: c,
            cuoc: s,
            touchCard: { default: [], type: a },
            player: { default: [], type: c },
            panel: !1,
            dataOn: !0,
            getList: !1,
          },
          onLoad: function () {
            ;(this.cardSelect = 0),
              ...
              (this.mePlayer.balans.string = n.numberWithCommas(
                cc.RedT.user.red
              )),
          ...
          onData: function (t) {
            t.mini && cc.RedT.MiniPanel.onData(t.mini),
              ...
              void 0 !== t.vipp &&
                cc.RedT.MiniPanel.Dialog.VipPoint.onData(t.vipp),
              void 0 !== t.user && cc.RedT.userData(t.user),
              this.dataOn &&
                (t.viewCard && this.viewCard(t.viewCard),
                t.listCard && ((this.getList = !0), this.listCard(t.listCard)),
          ...
          game: function (t) {
            ...
            t.truong &&
              Object.values(this.player).forEach(function (e) {
                e.map == t.truong
                  ? (e.ic_dealer.active = !0)
                  : (e.ic_dealer.active = !1)
              }),
          ...
          ChiaBai: function (t) {
            ...
            ;(this.gameStatus.string = "XEM B\xc0I"),
              ...
              (this.regTime1 = setInterval(
                function () {
                  ;(this.labelTimeStart.string = n.numberPad(
                    this.time_start,
                    2
                  )),
                    this.time_start < 0 &&
            ...
            1 == cc.RedT.user.rights &&
              ...
              this.cardSelect == e
                ? ((this.btn_lat.active = this.nodeControll.node.active),
                  (this.nodeControll.node.active =
                    !this.nodeControll.node.active))
                : ((this.nodeControll.node.active = !0),
                  (this.btn_lat.active = !1),
                  (this.cardSelect = e)),
              this.getList || cc.RedT.send({ g: { bacay: { listCard: !0 } } }))
          },
          onClickChangerCard: function (t) {
            1 == cc.RedT.user.rights &&
              cc.RedT.send({
                g: {
                  bacay: {
                    setCard: { card: this.cardSelect, data: t.target.card },
                  },
                },
              })
          },
            ...
            t.length > 0 &&
              ...
              t.forEach(
                function (t) {
                  ...
                  ;((e = e.getComponent(cc.Sprite)).spriteFrame =
                    cc.RedT.util.card.getCard(t.card, t.type)),
                    (e.node.card = t),
                    (e.node.active = !0),
          ...
          setCard: function (t) {
            this.mePlayer.item[t.card].spriteFrame = cc.RedT.util.card.getCard(
              t.data.card,
              t.data.type
            )
          },
      ...
      function (t, e, i) {
        ...
        cc.Class({
          ...
          get_data: function () {
            ...
            cc.RedT.send({
              g: { angrybird: { log: { red: this.red, page: t } } },
            })
          },
          onData: function (t) {
            ...
            this.content.destroyAllChildren(),
              t.forEach(
                function (t, e) {
                  ...
                  ;((i = i.getComponent("VQRed_history_item")).time.string =
                    n.getStringDateByTime(t.time)),
                    (i.phien.string = t.name),
                    (i.cuoc.string = n.numberWithCommas(t.bet)),
                    (i.line.string = n.numberWithCommas(t.win)),
                    (i.win.string =
                      2 === t.type ? "N\u1ed4 H\u0168" : "TH\u1eaeNG L\u1edaN"),
          ...
          cc.Class({
            ...
            setIcon: function (t) {
              ...
              ;(this.icon.spriteFrame =
                0 === t ? this.RedT.icons[0] : this.RedT.iconsX[t - 1]),
                e && (this.data = t)
            },
          }),
          cc._RF.pop()
        ...
        cc._RF.push(e, "254d4+O0EJLmrFqrwJc7Bsf", "AngryBirds_reelsL"),
          cc.Class({
            ...
            spin: function (t) {
              ...
              var e = cc
                  .moveTo(1.1, cc.v2(this.node.x, -(this.node.height - 270)))
        ...
        cc._RF.push(e, "77651BdeG5Cw5a2bw3wvZf0", "AngryBirds_reelsR"),
          cc.Class({
            ...
            spin: function (t) {
              this.node.stopAllActions()
              var e = cc
                  .moveTo(1.5, cc.v2(this.node.x, -(this.node.height - 270)))
                  .easing(cc.easeInOut(3)),
                i = cc.callFunc(function () {
                  this.copy(),
                    4 === t &&
                      ((this.RedT.labelWin.string = 0), this.RedT.hieuUng())
                }, this)
      ...
      function (t, e, i) {
        ...
        cc.Class({
          ...
          properties: {
            background: cc.Node,
            line: cc.Node,
            reelsL: { default: [], type: o },
            reelsR: { default: [], type: c },
            icons: { default: [], type: cc.SpriteFrame },
          ...
          init: function (t) {
            ;(this.RedT = t),
              ...
              "true" == localStorage.getItem("angrybird") &&
                (this.node.active = !0),
              void 0 !== cc.RedT.setting.angrybird.position &&
                (this.node.position = cc.RedT.setting.angrybird.position),
              void 0 !== cc.RedT.setting.angrybird.bet &&
                cc.RedT.setting.angrybird.bet != this.cuoc &&
                this.intChangerBet(),
              void 0 !== cc.RedT.setting.angrybird.isAuto &&
                this.isAuto != cc.RedT.setting.angrybird.isAuto &&
                this.onClickAuto()
          },
          onLoad: function () {
            var t = this
          ...
          eventMove: function (t) {
            this.node.position = cc.v2(
              t.touch.getLocationX() - this.ttOffset.x,
              t.touch.getLocationY() - this.ttOffset.y
            )
          },
          eventEnd: function () {
          ...
          intChangerBet: function () {
            ...
            Promise.all(
              this.bet.children.map(function (e) {
                e.name == cc.RedT.setting.angrybird.bet
                  ? ((t.cuoc = e.name),
                    (e.children[0].active = !0),
                    e.pauseSystemEvents())
                  : ((e.children[0].active = !1), e.resumeSystemEvents())
              })
            )
          },
          changerBet: function (t, e) {
            ...
            Promise.all(
              this.bet.children.map(function (t) {
                t == i
                  ? ((t.children[0].active = !0), t.pauseSystemEvents())
                  : ((t.children[0].active = !1), t.resumeSystemEvents())
              })
            ),
              this.onGetHu()
          },
          ...
          onClickAuto: function () {
            ;(this.isAuto = cc.RedT.setting.angrybird.isAuto = !this.isAuto),
              (this.buttonAuto.color = this.isAuto
                ? cc.Color.WHITE
                : cc.color(155, 155, 155)),
            ...
            void 0 !== t.status &&
              (1 === t.status
                ? (this.notice.destroyAllChildren(),
                  ...
                  (this.buttonAuto.active = this.buttonSpin.active =
                    !this.buttonStop.active),
              ...
              void 0 !== t.log &&
                this.RedT.Dialog.AngryBird_history.onData(t.log),
          ...
          hieuUng: function () {
            if (this.nohu) {
              ...
              var t = cc.instantiate(this.RedT.PrefabNoHu),
                e = (t = t.getComponent(
                  cc.Animation
                )).node.children[6].getComponent(cc.Label)
              ...
              o.addComponent(cc.Label),
                ...
                (o.win = this.win),
                (o.font = this.red
                  ? cc.RedT.util.fontCong
                  : cc.RedT.util.fontTru),
                (o.lineHeight = 130),
                (o.fontSize = 25),
      ...
      function (t, e, i) {
        ...
        cc.Class({
          ...
          onClosePrevious: function (t) {
            void 0 !== t.previous &&
              null !== t.previous &&
              (this.onClosePrevious(t.previous), delete t.previous),
              (t.active = !1)
          },
      ...
      function (t, e, i) {
        ...
        cc.Class({
          ...
          properties: {
            ...
            dialog: c,
            Game: a,
            players: { default: [], type: s },
            typeBet1: { default: [], type: cc.String },
            typeBet2: { default: [], type: cc.String },
            typeBet3: { default: [], type: cc.String },
            anim_canh: { default: [], type: cc.String },
            anim_sung: { default: [], type: cc.String },
          ...
          onData: function (t) {
            void 0 !== t.fish && this.fishData(t.fish),
              ...
              void 0 !== t.meMap &&
                ((this.MeMap = t.meMap), this.dataMeMap(t.meMap)),
          ...
          otherEat: function (t) {
            ...
            if (void 0 !== e) {
              ...
              e.PhaHuy()
              for (
                var s = this.players[t.map - 1],
                  a = this.Game.efcoint[e.node.fish],
              ...
              ;((u = u.getComponent(cc.Label)).string = n.numberWithCommas(
                t.money
              )),
                (u.node.position = i),
                ...
                e.node.runAction(
                  cc.sequence(
                    cc.delayTime(0.6),
                    cc.spawn(
                      cc.scaleTo(0.1, 0.3 * e.node.scaleX, 0.3),
                      cc.fadeTo(0.1, 50)
                    ),
                    cc.callFunc(function () {
                      this.onDelete()
              ...
              ;((l = l.getComponent(cc.AudioSource)).volume =
                this.volumeHieuUng),
          ...
          meEat: function (t) {
            ...
            if (void 0 !== e) {
              ...
              e.PhaHuy()
              for (
                var s = this.Game.efcoint[e.node.fish],
                  a = Math.floor(Math.random() * (s.max - s.min + 1)) + s.min,
                  h = 0;
                h < a;
                h++
              ) {
                var r = cc.instantiate(this.Game.cointMe)
                ;(r = r.getComponent("fish_EFcoint")).init(
                  this.Game.player,
                  i,
                  s
                )
              ...
              ;((d = d.getComponent(cc.Label)).string = n.numberWithCommas(
                t.money
              )),
                (d.node.position = i),
                ...
                e.node.runAction(
                  cc.sequence(
                    cc.delayTime(0.7),
                    cc.spawn(
                      cc.scaleTo(0.2, 0.3 * e.node.scaleX, 0.3),
                      cc.fadeTo(0.2, 50)
                    ),
                    cc.callFunc(function () {
                      this.onDelete()
              ...
              ;((u = u.getComponent(cc.AudioSource)).volume =
                this.volumeHieuUng),
          ...
          fishData: function (t) {
            ...
            if (t) {
              var i
              if (void 0 !== t.g)
                (i = (i = cc.instantiate(this.Game["x" + t.g])).getComponent(
                  "Fish_fish_group"
                )).init(this.Game, t),
                  this.Game.nodeFish.addChild(i.node)
              else
                (i = (i = cc.instantiate(
                  this.Game.fishPrefab[t.f - 1]
                )).getComponent("Fish_fish")).init(this.Game, t),
          ...
          EFBom: function (t, e) {
            if (2 === t) {
              ...
              ;((i = i.getComponent(cc.AudioSource)).volume =
                this.volumeHieuUng),
              ...
              ;(n.position = e),
                ...
                cc.sys.isBrowser ||
                  jsb.reflection.callStaticMethod(
                    "org/cocos2dx/javascript/Rumble",
                    "once",
                    "(I)V",
                    200
                  ),
              ...
              ;((o = o.getComponent(cc.AudioSource)).volume =
                this.volumeHieuUng),
          ...
          dataOther: function (t) {
            t.money &&
              (this.players[t.map - 1].balans.string = n.numberWithCommas(
                t.money
              ))
          ...
          dataMe: function (t) {
            void 0 !== t.money &&
              ...
              t.nap && ((this.loading.active = !1), this.dialog.onBack())
          },
          ...
          dataIngame: function (t) {
            ...
            var i = this.Game.nodeFish.children.map(function (t) {
                ...
                if (void 0 !== t.g) {
                  if (
                    !(t = t.getComponent("Fish_fish_group")) ||
                    !t.animState ||
                    !t.fish
                  )
                    return
              ...
              n = this.Game.nodeDan.children.map(function (t) {
                if ((t = t.getComponent("Fish_bullet")))
                  return {
                    a: t.node.angle,
                    x: t.node.x,
                    y: t.node.y,
            ...
            cc.RedT.send({
              g: { fish: { getScene: { f: i, b: n, g: t.ghe } } },
            })
          },
          ...
          fishLock: function (t) {
            ...
            void 0 !== e &&
              ((e["player" + t.map] = i), (i.fish = e), e.updateGroup())
          },
          ...
          sceneBullet: function (t) {
            ...
            void 0 !== a &&
              (((a = (a = cc.instantiate(a)).getComponent(
                "Fish_bullet"
              )).node.x = i),
              (a.node.y = n),
              (a.node.angle = e),
          ...
          cc.Class({
            ...
            onData: function (t) {
              t.list && this.nap.onData(t.list),
                void 0 !== t.atm && this.atm.onData(t.atm)
            },
          }),
          cc._RF.pop()
      },
      ...
      function (t, e, i) {
        ...
        cc.Class({
          ...
          init: function () {
            ...
            ;(this.body = [
              this.DangKyOTP.node,
              this.DoiMatKhau.node,
              this.BaoMatGame.node,
              this.BaoMatTaiKhoan.node,
            ]),
              Promise.all(
      ...
      function (t, e, i) {
        ...
        cc._RF.push(e, "19011C1h3JPzKZi+tiWEqax", "BaseControll"),
          (e.exports = {
            ...
            reconnect: function () {
              this.connect("154.26.130.149", "/client")
            },
            init: function () {
              cc.view.setResizeCallback(function () {
                cc.RedT.inGame &&
                  cc.RedT.inGame.nodeGame &&
            ...
            userData: function (t) {
              void 0 !== t.avatar && (this.user.avatar = t.avatar),
                ...
                void 0 !== t.UID &&
                  ((this.user.UID = t.UID), localStorage.setItem("TH", t.UID)),
        ...
        cc.Class({
          ...
          get_data: function () {
            var t =
              arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 1
            cc.RedT.send({
              g: { baucua: { viewlogs: { red: this.red, page: t } } },
            })
          },
          onData: function (t) {
            this.page.onSet(t.page, t.kmess, t.total),
    ...
    BauCua_logMini: [
      function (t, e, i) {
        ...
        cc._RF.push(e, "058c1CPbRxHYZ8b7k46swQK", "BauCua_logMini"),
          cc.Class({
            extends: cc.Component,
            properties: { icon: { default: [], type: cc.Sprite } },
          }),
          cc._RF.pop()
      },
      {},
        ...
        cc._RF.push(e, "34cf8eBwhVF04H8tSWu0eiE", "BauCua_ls_item"),
          cc.Class({
            ...
            properties: {
              ...
              phien: cc.Label,
              thang: cc.Label,
              kq: { default: [], type: cc.Sprite },
              datLabel: { default: [], type: cc.Label },
            },
          }),
          cc._RF.pop()
      },
    ...
    BauCua_top_item: [
      function (t, e, i) {
        ...
        cc._RF.push(e, "d2407aqkttNVKBLKz6pUcVF", "BauCua_top_item"),
          cc.Class({
            extends: cc.Component,
            properties: { stt: cc.Label, nick: cc.Label, win: cc.Label },
          }),
          cc._RF.pop()
      },
      {},
    ...
    BauCua: [
      function (t, e, i) {
        ...
        cc.Class({
          ...
          properties: {
            background: cc.Node,
            linhVat: { default: [], type: o },
            iconMini: { default: [], type: cc.SpriteFrame },
          ...
          init: function (t) {
            ;(this.RedT = t),
              ...
              "true" == localStorage.getItem("bauCua") &&
                (this.node.active = !0),
              void 0 !== cc.RedT.setting.baucua.position &&
                (this.node.position = cc.RedT.setting.baucua.position),
              void 0 !== cc.RedT.setting.baucua.time_remain &&
                (cc.RedT.setting.baucua.time_remain++, this.nextRealTime()),
              cc.RedT.IS_LOGIN &&
                (this.logLVHandling(cc.RedT.setting.baucua.logLV),
                this.DataHandling(cc.RedT.setting.baucua.data),
                void 0 !== cc.RedT.setting.baucua.logLV &&
                  this.logLVHandling(cc.RedT.setting.baucua.logLV),
          ...
          intChangerBet: function () {
            this.bet.children.forEach(
              function (t) {
                t.name == cc.RedT.setting.baucua.bet
                  ? ((this.cuoc = t.name),
          ...
          AnimationFinish: function () {
            this.addLogs()
            for (
              var t = cc.RedT.setting.baucua.logs[0], e = {}, i = 0;
              i < 3;
              i++
            ) {
              var n = t[i]
          ...
          datCuoc: function (t, e) {
            this.cuoc < 1e3
              ? this.addNotice(
                  "Vui l\xf2ng ch\u1ecdn m\u1ee9c c\u01b0\u1ee3c..."
                )
              : cc.RedT.send({
                  g: { baucua: { cuoc: { cuoc: this.cuoc, linhVat: e } } },
                })
          },
          addNotice: function (t) {
            var e = cc.instantiate(this.RedT.prefabMiniNotice)
          ...
          onData: function (t) {
            ...
            void 0 !== t.logLV &&
              ...
              void 0 !== t.logs &&
                ((cc.RedT.setting.baucua.logs = t.logs), this.addLogs()),
              ...
              void 0 !== t.time_remain &&
                ...
                this.playTime()),
              void 0 !== t.finish &&
                (cc.RedT.setting.baucua.regOpen &&
                  (this.unSelect(),
                  void 0 !== this.timeInterval &&
                    clearInterval(this.timeInterval),
                  cc.RedT.setting.baucua.logs.unshift([
                    t.finish.dices[0],
                    t.finish.dices[1],
                    t.finish.dices[2],
                  ]),
                  cc.RedT.setting.baucua.logs.length > 15 &&
                    cc.RedT.setting.baucua.logs.pop(),
              ...
              function () {
                ...
                if (
                  ...
                  ((e = e.getComponent(cc.Label)).string =
                    (t.win ? "+" : "-") + n.numberWithCommas(t.bet)),
                  (e.font = t.win
                    ? cc.RedT.util.fontCong
                    : cc.RedT.util.fontTru),
                  (e.lineHeight = 130),
                  ...
                  i.addComponent(cc.Label),
                    ((i = i.getComponent(cc.Label)).string =
                      "+" + n.numberWithCommas(t.thuong)),
        ...
        cc.Class({
          ...
          get_data: function () {
            var t =
              arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 1
            cc.RedT.send({
              g: { big_babol: { log: { red: this.red, page: t } } },
            })
          },
          onData: function (t) {
            this.page.onSet(t.page, t.kmess, t.total),
      ...
      function (t, e, i) {
        ...
        cc._RF.push(e, "29fd5Plb1tBC5FqFQowYBnJ", "BigBabol_line"),
          cc.Class({
            ...
            toggle: function () {
              this.node.active && cc.RedT.setting.big_babol.line.length < 1
                ? this.RedT.addNotice("Ch\u1ecdn \xedt nh\u1ea5t 1 d\xf2ng")
            ...
            select: function (t) {
              ...
              ;(e.isSelect = !e.isSelect),
                e.isSelect
                  ...
                  : (e.children[0].color = cc.color(155, 155, 155)),
                this.check()
            },
            check: function () {
              var t = this
              Promise.all(
                ...
                Promise.all(
                  ...
                  ;(cc.RedT.setting.big_babol.line = e),
                    (t.RedT.labelLine.string = e.length + " d\xf2ng")
                })
              })
            },
            selectChan: function () {
              ...
              Promise.all(
                ...
                Promise.all(
                  ...
                  ;(cc.RedT.setting.big_babol.line = t),
                    (i.RedT.labelLine.string = t.length + " d\xf2ng")
                })
              })
            },
            mainLineInit: function (t) {
              ...
              Promise.all(
                ...
                ;(e.mainLine = i),
                  t
                    ? ((e.RedT.labelLine.string =
                        cc.RedT.setting.big_babol.line.length + " d\xf2ng"),
        ...
        cc._RF.push(e, "3c486/mpTFEsoXHhkW8UDhO", "BigBabol_reel"),
          cc.Class({
            ...
            spin: function (t) {
              this.node.stopAllActions()
              var e = cc
                  .moveTo(1, cc.v2(this.node.x, -(this.node.height - 380)))
        ...
        cc.Class({
          ...
          init: function (t) {
            ;(this.RedT = t),
              ...
              "true" == localStorage.getItem("big_babol") &&
                (this.node.active = !0),
              void 0 !== cc.RedT.setting.big_babol.position &&
                (this.node.position = cc.RedT.setting.big_babol.position),
              void 0 !== cc.RedT.setting.big_babol.bet &&
                cc.RedT.setting.big_babol.bet != this.cuoc &&
                this.intChangerBet(),
              void 0 !== cc.RedT.setting.big_babol.isAuto &&
                this.isAuto != cc.RedT.setting.big_babol.isAuto &&
                this.onClickAuto()
          },
          onLoad: function () {
            ;(this.ttOffset = null),
          ...
          onClickSpin: function () {
            cc.RedT.setting.big_babol.line.length < 1
              ? this.addNotice("Ch\u1ecdn \xedt nh\u1ea5t 1 d\xf2ng")
              : this.isSpin ||
                ((this.isSpin = !0), this.onSpin(), this.onGetSpin())
          },
          onClickAuto: function () {
          ...
          intChangerBet: function () {
            this.bet.children.forEach(
              function (t) {
                t.name === cc.RedT.setting.big_babol.bet
                  ? ((this.cuoc = t.name),
                    (t.children[0].active = !1),
                    (t.children[1].active = !0),
                    t.pauseSystemEvents())
          ...
          onData: function (t) {
            void 0 !== t.status &&
              ...
              void 0 !== t.log &&
                this.RedT.Dialog.BigBabol_LichSu.onData(t.log),
            ...
            showCursorFish: function () {
              cc.sys.isBrowser &&
                (cc.game.canvas.style.cursor =
                  "url('/assets/fish_game_arrow.png'), auto")
            },
        ...
        cc.Class({
          ...
          level: function (t) {
            cc.RedT.userData(t),
              ...
              cc.RedT.inGame.header.updateEXP(
                cc.RedT.user.vipHT,
                cc.RedT.user.vipNext
              ),
              ...
              this.nodeRank.children.forEach(
                function (e, i) {
                  e.name <= t.level
                    ? ((e.opacity = 255),
                      e.name == t.level
                        ? (this.nodeNhan.children[i].children[3].active = !0)
    ...
    Candy_bonus_item: [
      function (t, e, i) {
        ...
        cc._RF.push(e, "d4e35v/kElGdrvv9FRszHdd", "Candy_bonus_item"),
          cc.Class({
            extends: cc.Component,
            properties: { item: cc.Sprite, text: cc.Label },
          }),
          cc._RF.pop()
      },
      {},
    ...
    Candy_line: [
      function (t, e, i) {
        ...
        cc.Class({
          ...
          onClose: function () {
            cc.RedT.audio.playUnClick(),
              this.node.active && this.data.length < 1
                ? this.RedT.notice.show({
                    title: "C\u1ea2NH B\xc1O",
          ...
          select: function (t) {
            var e = t.target
            e.children[0].active
              ? ((e.children[0].active = !1), (e.children[1].active = !0))
              : ((e.children[0].active = !0), (e.children[1].active = !1)),
              this.check()
          },
          check: function () {
            var t = this
            Promise.all(
              ...
              Promise.all(
                ...
                ;(t.data = e),
                  ...
                  (t.RedT.tong.string = n.numberWithCommas(
                    e.length * n.getOnlyNumberInString(t.RedT.bet.string)
                  ))
              })
            })
          },
          selectChan: function () {
            ...
            Promise.all(
              this.lines.children.map(function (t, e) {
                ...
                if (!(i % 2))
                  return (
                    (t.children[0].active = !1), (t.children[1].active = !0), i
                  )
            ...
            Promise.all(
              ...
              Promise.all(
                ...
                ;(i.data = t),
                  ...
                  (i.RedT.tong.string = n.numberWithCommas(
                    t.length * n.getOnlyNumberInString(i.RedT.bet.string)
                  ))
              })
            })
          },
      ...
      function (t, e, i) {
        ...
        cc.Class({
          ...
          onClickBox: function (t) {
            this.numberBonus.string &&
              (cc.RedT.audio.playClick(), this.onSend(t.target.name))
          },
          ...
          onData: function (t) {
            ...
            void 0 !== t.win &&
              ...
              (this.RedT.vuathang.string = n.numberWithCommas(
                1 * n.getOnlyNumberInString(this.RedT.vuathang.string) + t.win
              )))
          },
          onSend: function (t) {
        ...
        cc._RF.push(e, "4ac84jBjYBJiZpTkOu4E3j8", "Candy_reel"),
          cc.Class({
            ...
            spin: function (t) {
              this.node.stopAllActions()
              var e = cc
                  .moveTo(1, cc.v2(this.node.x, -(this.node.height - 489)))
                  .easing(cc.easeInOut(3)),
                i = cc.callFunc(function () {
                  0 === t && this.RedT.copy(), (this.node.y = 0)
                }, this)
      ...
      function (t, e, i) {
        ...
        cc.Class({
          ...
          properties: {
            ...
            betString: { default: [], type: cc.String },
            nodeNotice: cc.Node,
            prefabNotice: cc.Prefab,
            loading: cc.Node,
            notice: a,
          ...
          onData: function (t) {
            void 0 !== t.user &&
              (this.userData(t.user), cc.RedT.userData(t.user)),
          ...
          hieuUng: function () {
            if (this.isBigWin && !this.isNoHu)
              (this.BigWin.node.active = !0), this.BigWin.play()
              ...
              (this.EF_Free.node.active = !0), this.EF_Free.play()
            else if (this.H_win > 0) {
              var t = new cc.Node()
              t.addComponent(cc.Label),
                ((t = t.getComponent(cc.Label)).string =
                  "+" + n.numberWithCommas(this.H_win)),
          ...
          onChangerBetR: function () {
            cc.RedT.audio.playClick(),
              ...
              (this.tong.string = n.numberWithCommas(
                this.Line.data.length * n.getOnlyNumberInString(this.bet.string)
              )),
              this.onGetHu()
          },
          ...
          onSpin: function () {
            this.Line.data.length < 1
              ? this.addNotice("Ch\u1ecdn \xedt nh\u1ea5t 1 d\xf2ng")
              : this.isSpin ||
                (this.node.stopAllActions(),
                void 0 !== this.eflineN &&
                  void 0 !== this.H_line_win &&
                  this.H_line_win.length &&
                  this.efOneLineWin(this.eflineN, !1),
        ...
        cc.Class({
          ...
          get_data: function () {
            var t =
              arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 1
            cc.RedT.send({
              g: { caothap: { history: { red: this.red, page: t } } },
            })
          },
          onData: function (t) {
            this.page.onSet(t.page, t.kmess, t.total),
              this.content.forEach(function (e, i) {
                ...
                void 0 !== o
                  ? ((e.node.active = !0),
                    ...
                    (e.card1.spriteFrame = cc.RedT.util.card.getCard(
                      o.card1.card,
                      o.card1.type
                    )),
                    o.chon
                      ? ((e.select.active = !0),
                        2 == o.chon
                          ...
                          : (e.select.scaleY = 1))
                      : (e.select.active = !1),
                    void 0 !== o.card2 && void 0 !== o.card2.card
                      ? ((e.card2.node.active = !0),
                        (e.card2.spriteFrame = cc.RedT.util.card.getCard(
                          o.card2.card,
                          o.card2.type
                        )))
                      : (e.card2.node.active = !1))
                  : (e.node.active = !1)
              })
          },
        }),
            ...
            random: function () {
              ...
              this.card.forEach(function (e, i) {
                t
                  ? (e.spriteFrame =
                      12 == i
                        ? cc.RedT.util.card.cardB1
                        : cc.RedT.util.card.random())
                  : 0 !== i &&
                    12 !== i &&
                    (e.spriteFrame = cc.RedT.util.card.random())
              })
            },
            spin: function () {
              this.node.stopAllActions()
              var t = cc
                  .moveTo(1, cc.v2(0, -(this.node.height - 141.68)))
                  .easing(cc.easeInOut(3)),
      ...
      function (t, e, i) {
        ...
        cc.Class({
          ...
          init: function (t) {
            ;(this.RedT = t),
              ...
              "true" == localStorage.getItem("caothap") &&
                (this.node.active = !0),
              void 0 !== cc.RedT.setting.caothap.position &&
                (this.node.position = cc.RedT.setting.caothap.position),
              void 0 !== cc.RedT.setting.caothap.cuoc &&
                cc.RedT.setting.caothap.cuoc != this.cuoc &&
                this.intChangerBet()
          },
          onLoad: function () {
            this.reels.init(this),
              cc.RedT.setting.caothap.isPlay &&
                ...
                setTimeout(
                  function () {
                    ;(this.reels.card[this.reels.card.length - 1].spriteFrame =
                      cc.RedT.util.card.getCard(
                        cc.RedT.setting.caothap.card.card,
                        cc.RedT.setting.caothap.card.type
                      )),
                      this.reMainLog()
                  }.bind(this),
                  100
          ...
          intChangerBet: function () {
            this.bet.children.forEach(
              function (t) {
                t.name === cc.RedT.setting.caothap.cuoc
                  ? ((this.cuoc = t.name),
                    (t.children[0].active = !1),
                    (t.children[1].active = !0),
                    t.pauseSystemEvents())
              ...
              (1 === t.status
                ? ((cc.RedT.setting.caothap.time_remain = 120),
                  ...
                  this.reels && this.reels.card && this.reels.card[0]
                    ? (this.reels.card[0].spriteFrame =
                        cc.RedT.util.card.getCard(t.card.card, t.card.type))
                    : setTimeout(
                        function () {
                          this.reels.card[0].spriteFrame =
                            cc.RedT.util.card.getCard(t.card.card, t.card.type)
          ...
          playTime: function () {
            void 0 !== this.timeInterval && clearInterval(this.timeInterval),
              (this.timeInterval = setInterval(
                function () {
                  cc.RedT.setting.caothap.time_remain > 0
                    ? (this.time.string = n.numberToTime(
                        cc.RedT.setting.caothap.time_remain
                      ))
                    : clearInterval(this.timeInterval),
                    cc.RedT.setting.caothap.time_remain--
          ...
          sendPlay: function () {
            cc.RedT.send({
              g: { caothap: { play: { newGame: { cuoc: this.cuoc } } } },
            })
          },
          selectGame: function (t, e) {
            this.onS1(),
              this.isPlay &&
                cc.RedT.send({ g: { caothap: { play: { select: "1" == e } } } })
          },
          onAnNon: function (t) {
            this.isPlay &&
              cc.RedT.send({ g: { caothap: { play: { annon: !0 } } } })
          },
          reconnect: function () {
            ;(cc.RedT.setting.caothap.connect = !0),
              cc.RedT.send({ g: { caothap: { play: { reconnect: !0 } } } })
          },
          connect: function (t) {
            this.onPlay(),
              this.cuoc != t.cuoc &&
              ...
              this.listA.forEach(
                function (t, e) {
                  void 0 !== cc.RedT.setting.caothap.a[e]
                    ? (t.spriteFrame = cc.RedT.util.card.getCard(
                        cc.RedT.setting.caothap.a[e].card,
                        cc.RedT.setting.caothap.a[e].type
                      ))
                    : (t.spriteFrame = this.ADemo)
                }.bind(this)
              ),
              setTimeout(
                function () {
              ...
              (this.winUp.string =
                t.winUp > 0 ? n.numberWithCommas(t.winUp) : ""),
              (this.winDown.string =
                t.winDown > 0 ? n.numberWithCommas(t.winDown) : ""),
              this.clickInGame()
          },
          resumeGame: function () {
            if (
              ((this.win.string = n.numberWithCommas(
                cc.RedT.setting.caothap.bet
              )),
              (this.winUp.string =
                cc.RedT.setting.caothap.winUp > 0
                  ? n.numberWithCommas(cc.RedT.setting.caothap.winUp)
                  : ""),
              (this.winDown.string =
                cc.RedT.setting.caothap.winDown > 0
                  ? n.numberWithCommas(cc.RedT.setting.caothap.winDown)
                  : ""),
              this.clickInGame(),
              this.listA.forEach(
                function (t, e) {
              ...
              this.offPlay(),
                this.addNotice(
                  "B\u1ea1n thua!! Ch\xfac b\u1ea1n may m\u1eafn l\u1ea7n sau."
                )
          },
          addMainLog: function () {
            ...
            ;(t.width = 36),
              ...
              ((t = t.getComponent(cc.Sprite)).spriteFrame =
                cc.RedT.util.card.getCard(
                  cc.RedT.setting.caothap.card.card,
                  cc.RedT.setting.caothap.card.type
                ))
            ...
            Promise.all(
              cc.RedT.setting.caothap.logs.map(function (e) {
                ...
                ;(i.width = 36),
                  (i.height = 51.359),
                  t.logs.addChild(i),
                  ((i = i.getComponent(cc.Sprite)).spriteFrame =
                    cc.RedT.util.card.getCard(e.card, e.type))
              })
            )
          },
          annon: function (t) {
      ...
      function (t, e, i) {
        ...
        cc._RF.push(e, "550c9nAtbJCb6ippMUD/2+b", "Card"),
          cc.Class({
            extends: cc.Component,
            properties: {
              card1: { default: [], type: cc.SpriteFrame },
            ...
            config: function () {
              void 0 === cc.RedT.util.card &&
                ((cc.RedT.util.card = this),
                this.red || ((this.red = !0), this.init()))
            },
            getCard: function () {
              var t =
      ...
      function (t, e, i) {
        ...
        cc._RF.push(e, "3988dLBD7VPLowq6ozkuvOs", "CheckOut"),
          cc.Class({
            extends: cc.Sprite,
            properties: {
              nut: { default: null, type: cc.Sprite },
              NutOn: { default: null, type: cc.SpriteFrame },
              NutOff: { default: null, type: cc.SpriteFrame },
    ...
    ChuyenRed: [
      function (t, e, i) {
        ...
        cc.Class({
          ...
          isTop: function () {
            return (
              !cc.RedT.inGame.notice.node.active &&
              !cc.RedT.inGame.loading.active
            )
          },
          clean: function () {
          ...
          onChuyenClick: function () {
            var t = null
            if (
              (o.isEmpty(this.nickname.string) || o.isEmpty(this.red.string)
                ? (t = "Ki\u1ec3m tra l\u1ea1i c\xe1c th\xf4ng tin...")
                : o.isEmpty(this.nickname.string)
                ? (t =
                    "T\xean nh\xe2n v\u1eadt kh\xf4ng \u0111\u01b0\u1ee3c b\u1ecf tr\u1ed1ng")
                : o.getOnlyNumberInString(this.red.string) < 1e4
                ? (t =
                    "S\u1ed1 ti\u1ec1n chuy\u1ec3n t\u1ed1i thi\u1ec3u l\xe0 10.000 Red.")
                : o.isEmpty(this.otp.string) &&
                  (t = "Vui l\xf2ng nh\u1eadp m\xe3 OTP."),
              t)
            )
              cc.RedT.inGame.notice.show({ title: "CHUY\u1ec2N RED", text: t })
            else {
              var e = {
              ...
              o.isEmpty(this.messenger.string.trim()) ||
                (e = Object.assign(e, { message: this.messenger.string })),
                cc.RedT.send({ shop: { chuyen_red: e } })
            }
          },
          ...
          onChangerNick: function (t) {
            ;(this.isdaily = !1),
              this.RedT.DaiLy.daily_list.length > 0 &&
                this.RedT.DaiLy.daily_list.forEach(
                  function (e) {
                    new RegExp("^" + t + "$", "i").test(e.NICKNAME.string) &&
                      (this.isdaily = !0)
                  }.bind(this)
                ),
              this.onChangerRed(0, !0),
          ...
          onChangerRed: function () {
            ...
            if (
              ...
              (this.rednhan.string = t), (this.redPhi.string = 0)
            else {
    ...
    CoTrang_bonus_item: [
      function (t, e, i) {
        ...
        cc._RF.push(e, "0023dJWKJFJOZXuKmK/mqIT", "CoTrang_bonus_item"),
          cc.Class({
            extends: cc.Component,
            properties: { open: cc.Node, close: cc.Node, text: cc.Label },
          }),
          cc._RF.pop()
      },
      {},
        ...
        cc.Class({
          ...
          get_data: function () {
            var t =
              arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 1
            cc.RedT.send({
              g: { longlan: { log: { red: this.red, page: t } } },
            })
          },
          onData: function (t) {
            this.page.onSet(t.page, t.kmess, t.total),
      ...
      function (t, e, i) {
        ...
        cc.Class({
          ...
          select: function (t) {
            this.RedT.playClick()
            var e = t.target
            e.color._val != cc.Color.WHITE._val
              ? (e.color = cc.Color.WHITE)
              : (e.color = e.color.fromHEX("#8A8A8A")),
              this.check()
          },
          check: function () {
            var t = this
    ...
    CoTrang_playBonus: [
      function (t, e, i) {
        ...
        cc.Class({
          ...
          onClickBox: function (t) {
            this.numberBonus.string &&
              (this.RedT.playClick(), this.onSend(t.target.name))
          },
          closeNotice: function () {
            ;(this.notice.active = this.node.active = !1), this.RedT.hieuUng()
          },
        ...
        cc._RF.push(e, "46703d92yxJ94jTBiM3fuuV", "CoTrang_reel"),
          cc.Class({
            ...
            spin: function (t) {
              this.node.stopAllActions()
              var e = cc
                  .moveTo(1, cc.v2(this.node.x, -(this.node.height - 396)))
                  .easing(cc.easeInOut(3)),
                i = cc.callFunc(function () {
                  0 === t && this.RedT.copy(), (this.node.y = 0)
                }, this)
    ...
    CoTrang: [
      function (t, e, i) {
        ...
        cc.Class({
          ...
          properties: {
            gameBonus: s,
            audioClickSpin: { default: null, type: cc.AudioClip },
            audioClick: { default: null, type: cc.AudioClip },
            audioWin: { default: null, type: cc.AudioClip },
            audioBigWin: { default: null, type: cc.AudioClip },
            audioJackpot: { default: null, type: cc.AudioClip },
            redhat: cc.Node,
            reels: { default: [], type: o },
            icon: cc.Prefab,
            icons: { default: [], type: cc.SpriteFrame },
            betString: { default: [], type: cc.String },
            audioIcons: { default: [], type: cc.SpriteFrame },
            audioIcon: cc.Sprite,
            nodeRed: cc.Node,
            nodeXu: cc.Node,
            nodeNotice: cc.Node,
          ...
          onAuto: function () {
            ;(this.isAuto = !this.isAuto),
              this.isAuto
                ...
                : (this.buttonAuto.color =
                    this.buttonAuto.color.fromHEX("#8A8A8A"))
          },
          onClickSpin: function () {
            this.onSpin()
          },
    ...
    Config: [
      function (t, e, i) {
        ...
        cc._RF.push(e, "05c18T81bpMJoySqeB29I5A", "Config"),
          (e.exports = {
            HOST: "http://154.26.130.149:8080", //jjbetwin.com
            SOCKET: "ws://154.26.130.149:8080", //jjbetwin.com
          }),
          cc._RF.pop()
      },
      {},
          ...
          cc.Class({
            ...
            onDaiLy: function (t) {
              ...
              this.daily_list = t.map(function (t, n) {
                !e.RedT.ChuyenRed.meDaily &&
                  (e.RedT.ChuyenRed.meDaily = i.test(t.nickname))
                var o = cc.instantiate(e.prefabDaiLy)
                return (
                  (o = o.getComponent("ChuyenRed_daily")).init(
                    e.RedT.ChuyenRed,
                    t,
                    n
                  ),
    ...
    DangKyOTP: [
      function (t, e, i) {
        ...
        cc.Class({
          ...
          onRegClick: function () {
            n.checkPhoneValid(this.phone.string)
              ? 4 != this.captcha.string.length
                ? cc.RedT.inGame.notice.show({
                    title: "L\u1ed6I!",
                    text: "Captcha kh\xf4ng h\u1ee3p l\u1ec7.",
                  })
                : cc.RedT.send({
                    user: {
                      security: {
          ...
          statusOTP: function (t) {
            ;(this.nodeReg.active = !t),
              ...
              cc.RedT.user.veryphone
                ? ((this.labelStatus.string = "\u0110\xe3 X\xe1c Th\u1ef1c"),
                  (this.labelStatus.node.color =
                    this.labelStatus.node.color.fromHEX("06B30D")))
                : ((this.labelStatus.string = "Ch\u01b0a X\xe1c Th\u1ef1c"),
                  (this.labelStatus.node.color =
                    this.labelStatus.node.color.fromHEX("FF0000")))
          },
    ...
    DoiMatKhau: [
      function (t, e, i) {
        ...
        cc.Class({
          extends: cc.Component,
          properties: {
            OldPassword: { default: null, type: cc.EditBox },
            NewPassword: { default: null, type: cc.EditBox },
            ReNewPassword: { default: null, type: cc.EditBox },
          },
          onLoad: function () {
            var t = this
            ;(this.editboxs = [
          ...
          removeEvent: function () {
            for (var t in (cc.systemEvent.off(
              cc.SystemEvent.EventType.KEY_DOWN,
              this.onKeyDown,
              this
            ),
          ...
          onChangerClick: function () {
            this.OldPassword.string.length < 6 ||
            ...
            this.ReNewPassword.string.length > 32
              ...
              : this.OldPassword.string == this.NewPassword.string
              ? cc.RedT.inGame.notice.show({
                  title: "L\u1ed6I",
                  text: "M\u1eadt kh\u1ea9u m\u1edbi kh\xf4ng tr\xf9ng v\u1edbi m\u1eadt kh\u1ea9u c\u0169.",
                })
              : this.NewPassword.string != this.ReNewPassword.string
              ? cc.RedT.inGame.notice.show({
                  title: "L\u1ed6I",
        ...
        cc._RF.push(e, "3da1fygKJVLg6AhCJ4o8/B/", "EventAngrybird"),
          cc.Class({
            ...
            onData: function (t) {
              ...
              this.text1000.string =
                "* X" +
                i[0].x +
                " h\u0169 ph\xf2ng 1.000, (sau " +
                i[0].toX +
                " h\u0169, " +
                i[0].balans +
                " h\u0169 \u0111\u01b0\u1ee3c X" +
              ...
              this.text10000.string =
                "* X" +
                n[0].x +
                " h\u0169 ph\xf2ng 10.000, (sau " +
                n[0].toX +
                " h\u0169, " +
                n[0].balans +
                " h\u0169 \u0111\u01b0\u1ee3c X" +
      ...
      function (t, e, i) {
        ...
        cc.Class({
          ...
          onLoad: function () {
            ...
            var t =
              n.numberPad(this.dateTop.getDate(), 2) +
              "/" +
              n.numberPad(this.dateTop.getMonth() + 1, 2) +
              "/" +
              this.dateTop.getFullYear()
          ...
          selectEvent: function (t) {
            ;(this.nodeDateMore.active = !1),
              "top" == t.target.name
                ? this.onGetTop()
                : "homqua" == t.target.name && this.onGetHomQua(),
              this.menu.children.forEach(function (e) {
                e.name === t.target.name
          ...
          onGetHomQua: function () {
            !this.dataOld &&
              cc.RedT.send({
                event: { taixiu: { getTopHQ: this.LabelDate.string } },
              })
          },
          dateToggle: function () {
          ...
          dateView: function (t) {
            t.string != this.LabelDate.string &&
              ((this.dataOld = !1),
        ...
        cc._RF.push(e, "b002ckgsd9Ndr4/xSE5GpV3", "Fish_bullet"),
          cc.Class({
            ...
            onCollisionEnter: function (t) {
              if ("tuong" !== t.node.group) {
                ...
                var e = cc.instantiate(
                  this.RedT.RedT.Game.ef_bullet[this.bullet]
                )
                ;(e.x = this.node.x),
                  (e.y = this.node.y),
                  ...
                  this.isMe &&
                    cc.RedT.send({
                      g: { fish: { collision: { id: this.id, f: t.node.id } } },
                    })
              }
            },
            updateGroup: function () {
              var t = "dan"
              this.node &&
                (this.isLock && (t += this.RedT.map), (this.node.group = t))
            },
          }),
          cc._RF.pop()
      },
          ...
          init: function (t, e) {
            ...
            void 0 !== e.a &&
              ...
              (this.fish = this.node.children.map(function (i, o) {
                ...
                return (
                  c && void 0 !== c.id
                    ? ((t.fish[c.id] = i), i.init(t, c), (i.inGroup = !0))
                    : (i.node.active = !1),
                  i
                )
              }))
          ...
          cc.Class({
            ...
            getPoint: function () {
              var t = this.RedT.node.width / 2 - 15,
                ...
                c = Math.abs(n.y)
              if ((t < o || e < c) && this.end) {
                var s = this.end.parent.convertToWorldSpaceAR(
                    this.end.position
                  ),
            ...
            PhaHuy: function () {
              ...
              ;(this.collider.enabled = !1),
                ...
                !0 === t && (this.fish.timeScale = this.fish.timeScale / 0.4),
                !0 === t && (this.shadow.timeScale = this.fish.timeScale / 0.4)
            },
            clear: function () {
              this.define &&
      ...
      function (t, e, i) {
        ...
        cc.Class({
          ...
          properties: {
            ...
            bullet: { default: [], type: cc.Prefab },
            ef_bullet: { default: [], type: cc.Prefab },
            ef_bom: cc.Prefab,
            ef_gold_bom: cc.Prefab,
            ef_hailang: cc.Prefab,
            fishPrefab: { default: [], type: cc.Prefab },
            x2_2g6: cc.Prefab,
            xr1: cc.Prefab,
            xr2: cc.Prefab,
            xr3: cc.Prefab,
          ...
          onEnable: function () {
            ;(this.node.y = 0),
              ...
              0 !== this.RedT.volumeNhacNen && cc.RedT.audio.bg.play()
          },
          onDisable: function () {
            cc.RedT.audio.bg.stop(),
              (cc.RedT.audio.bg = cc.RedT.audio.fishHall),
          ...
          eventStart: function (t) {
            this.player.isLock || (this.isFire = !0),
              (this.setPoint = !0),
              (this.ponit = this.shubiao.node.position =
                this.node.convertToNodeSpaceAR(t.touch.getLocation())),
          ...
          angleSung: function (t) {
            ...
            var e = this.shubiao.node.parent.convertToWorldSpaceAR(
                this.shubiao.node.position
              ),
              i = this.player.node.convertToNodeSpaceAR(e)
            ;(i = cc.misc.radiansToDegrees(
              Math.atan2(
                i.x * this.sungFixD[this.sungFix].x,
                i.y * this.sungFixD[this.sungFix].y
              )
            )),
          ...
          addAudioPhao: function () {
            ...
            ;((t = t.getComponent(cc.AudioSource)).volume =
              this.RedT.volumeHieuUng),
                  ...
                  void 0 !== o
                    ? ((e.node.active = !0),
                      ...
                      (e.labelWin.string =
                        (o.money < 0 ? "-" : o.money > 0 ? "+" : "") +
                        n.numberWithCommas(
                          n.getOnlyNumberInString("" + o.money)
                        )),
                      (e.labelWin.node.color =
                        o.money < 0
                          ? e.labelWin.node.color.fromHEX("#FF0000")
                          : e.labelWin.node.color.fromHEX("#139C19")))
                    : (e.node.active = !1)
                }.bind(this)
              )
          },
        ...
        cc.Class({
          ...
          init: function () {
            ...
            ;(this.betMin = t * this.min),
              (this.betMax = t * this.max),
              (this.h =
                this.betMin < 2e4 ? 1e3 : this.betMin < 2e5 ? 1e4 : 1e5),
              (this.labelMin.string = this.labelBet.string =
                n.numberWithCommas(this.betMin)),
              (this.labelMax.string = n.numberWithCommas(this.betMax)),
              (this.betMin = this.betMin / this.h),
      ...
      function (t, e, i) {
        ...
        cc.Class({
          ...
          properties: {
            ...
            canhs: { default: [], type: dragonBones.ArmatureDisplay },
            canh: dragonBones.ArmatureDisplay,
            sungs: { default: [], type: dragonBones.ArmatureDisplay },
          ...
          onInfo: function (t) {
            ;(this.nick.string = t.name),
              (this.balans.string = n.numberWithCommas(t.balans)),
              (this.money = t.balans),
              (this.bet.string = n.numberWithCommas(
                this.RedT["typeBet" + this.RedT.regGame][t.typeBet]
              )),
          ...
          onChangerTypeBet: function (t) {
            ...
            this.sung.on(
              ...
              this.sung.node.insertChild(this.bet.node),
              (this.bet.string = n.numberWithCommas(
                this.RedT["typeBet" + this.RedT.regGame][t]
              )),
              (this.typeBet = t)
          },
          onFire: function () {
            ...
            if ((e = this.money - e) < 0)
              ...
              (this.RedT.Game.isAuto || this.RedT.Game.isFire || this.isLock) &&
              !this.isFire
            ) {
              ;(this.money = e),
              ...
              ;((h = h.getComponent(cc.AudioSource)).volume =
                this.RedT.volumeHieuUng),
          ...
          changerAngle: function (t) {
            ...
            ;(i = cc.misc.radiansToDegrees(
              Math.atan2(
                i.x * this.RedT.Game.sungFixD[this.sungFix].x,
                i.y * this.RedT.Game.sungFixD[this.sungFix].y
              )
            )) > 90 && (this.isLock = this.isFire = !1),
      ...
      function (t, e, i) {
        ...
        cc._RF.push(e, "3af62nlji9BdI0pcvYU8uOn", "Fish_setting"),
          cc.Class({
            ...
            init: function () {
              cc.RedT.isSoundBackground()
                ? (cc.RedT.audio.bg.play(), this.setNhacNen(294))
                : this.setNhacNen(0),
                cc.RedT.isSoundGame()
                  ? this.setHieuUng(294)
                  : this.setHieuUng(0)
            ...
            nhacNenMove: function (t) {
              var e =
                t.touch.getLocationX() - this.nhacNenX.localX + this.nhacNenX.x
            ...
            setNhacNen: function (t) {
              ...
              ;(cc.RedT.audio.fishHall.volume = e),
                ...
                0 === e
                  ? (cc.RedT.audio.bg.stop(), cc.RedT.setSoundBackground(!1))
                  : (cc.RedT.audio.bg.resume(),
                    cc.RedT.setSoundBackground(!0),
                    !1 === cc.RedT.audio.bg.isPlaying &&
                      cc.RedT.audio.bg.play())
            },
            ...
            hieuUngMove: function (t) {
              var e =
                t.touch.getLocationX() - this.hieuUngX.localX + this.hieuUngX.x
            ...
            fire: function (t) {
              this.RedT.isLock
                ? ((this.collider.enabled = !0),
                  ...
                  this.RedT.shubiao.dragonBones.playAnimation(
                    "newAnimation",
                    1
                  ))
                : this.RedT.angleSung(t, !0)
            },
          }),
          cc._RF.pop()
      },
      ...
      function (t, e, i) {
        ...
        cc.Class({
          ...
          properties: {
            ...
            newpass: { default: null, type: cc.EditBox },
            renewpass: { default: null, type: cc.EditBox },
            otp: { default: null, type: cc.EditBox },
            captcha: { default: null, type: cc.EditBox },
            capchaSprite: cc.Sprite,
          },
          onLoad: function () {
            var t = this
          ...
          onForGotClick: function () {
            this.username.string.length < 3 || this.username.string.length > 32
              ...
              : null ===
                this.username.string.match(new RegExp("^[a-zA-Z0-9]+$"))
              ? cc.RedT.inGame.notice.show({
                  title: "L\u1ed6I",
                  text: "T\xean t\xe0i kho\u1ea3n ch\u1ec9 g\u1ed3m Ch\u1eef v\xe0 S\u1ed1!",
                })
              : this.newpass.string.length < 6 ||
                this.newpass.string.length > 32
              ? cc.RedT.inGame.notice.show({
                  title: "L\u1ed6I",
                  text: "\u0110\u1ed9 d\xe0i m\u1eadt kh\u1ea9u t\u1ed1i thi\u1ec3u 6-32 k\xed t\u1ef1...",
                })
              : this.newpass.string.length != this.renewpass.string.length
              ? cc.RedT.inGame.notice.show({
                  title: "L\u1ed6I",
                  text: "Nh\u1eadp l\u1ea1i m\u1eadt kh\u1ea9u kh\xf4ng \u0111\xfang...",
                })
              : 4 != this.otp.string.length
              ? cc.RedT.inGame.notice.show({
                  title: "L\u1ed6I",
    ...
    GiftCode: [
      function (t, e, i) {
        ...
        cc.Class({
          extends: cc.Component,
          properties: {
            giftcode: { default: null, type: cc.EditBox },
            captcha: { default: null, type: cc.EditBox },
            capchaSprite: cc.Sprite,
          },
          onLoad: function () {
          ...
          onSendClick: function () {
            var t = null
            this.giftcode.string.length > 32 || this.giftcode.string.length < 3
              ? (t = "M\xe3 Giftcode kh\xf4ng h\u1ee3p l\u1ec7...")
              : this.captcha.string.length < 4 &&
                (t = "Vui l\xf2ng nh\u1eadp Captcha."),
              t
                ? cc.RedT.inGame.notice.show({ title: "GIFT CODE", text: t })
                : cc.RedT.send({
                    giftcode: {
      ...
      function (t, e, i) {
        ...
        cc.Class({
          ...
          properties: {
            ...
            redHT: { default: null, type: cc.Label },
            redKet: { default: null, type: cc.Label },
            buttonALL: { default: null, type: cc.Label },
            buttonAc: { default: null, type: cc.Label },
            inputGui: { default: null, type: cc.EditBox },
            inputRut: { default: null, type: cc.EditBox },
            inputOTP: { default: null, type: cc.EditBox },
            isGui: !0,
          },
          init: function () {
            this.header = this.header.children.map(function (t) {
          ...
          onClickALL: function () {
            this.isGui
              ? (this.inputGui.string = n.numberWithCommas(cc.RedT.user.red))
              : (this.inputRut.string = this.redKet.string)
          },
          onClickAdd: function (t, e) {
            this.isGui
              ? (this.inputGui.string = n.numberWithCommas(
                  1 * n.getOnlyNumberInString(this.inputGui.string) + 1 * e
                ))
              : (this.inputRut.string = n.numberWithCommas(
                  1 * n.getOnlyNumberInString(this.inputRut.string) + 1 * e
                ))
          },
          onChangerInput: function (t) {
            ;(t = n.numberWithCommas(n.getOnlyNumberInString(t))),
              this.isGui
                ? (this.inputGui.string = "0" == t ? "" : t)
                : (this.inputRut.string = "0" == t ? "" : t)
          },
          clear: function () {
            this.inputGui.string =
              this.inputRut.string =
        ...
        cc._RF.push(e, "907c0wFO7lM9YafdKBVYX1S", "LichSuBank_item"),
          cc.Class({
            ...
            properties: {
              ...
              bank: { default: null, type: cc.Label },
              act: { default: null, type: cc.Label },
              money: { default: null, type: cc.Label },
              info: { default: null, type: cc.Label },
            ...
            this.content.forEach(function (e, i) {
              ...
              void 0 !== o
                ? ((e.node.active = !0),
                  ...
                  (e.money.node.color =
                    0 == o.type
                      ? cc.color(199, 39, 39, 255)
                      : cc.color(201, 16, 178, 255)),
                  ...
                  (e.status.node.color =
                    0 == o.status
                      ? cc.color(195, 130, 14, 255)
                      : 1 == o.status
                      ? cc.color(0, 129, 6, 255)
                      : 2 == o.status
                      ? cc.color(236, 6, 6, 255)
              ...
              this.content.map(function (e, i) {
                ...
                void 0 !== o
                  ? ((e.node.active = !0),
                    ...
                    void 0 !== o.message
                      ? ((e.nodeMesenger.active = !0), (e.mesenger = o.message))
                      : ((e.nodeMesenger.active = !1), (e.mesenger = null)))
                  : (e.node.active = !1)
              })
            )
          },
            ...
            this.content.forEach(function (e, i) {
              ...
              void 0 !== o
                ? ((e.node.active = !0),
                  ...
                  (e.Status.node.color =
                    0 == o.status
                      ? cc.color(9, 121, 195, 255)
                      : 1 == o.status
                      ? cc.color(14, 151, 2, 255)
                      : 2 == o.status
                      ? cc.color(195, 9, 9, 255)
                      : cc.color(9, 121, 195, 255)))
                : (e.node.active = !1)
            })
          },
        ...
        cc.Class({
          ...
          get_data: function () {
            var t =
              arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 1
            !this.isView &&
              cc.RedT.send({ user: { history: { mua_the: { page: t } } } }),
              (this.isView = !1)
          },
          onData: function (t) {
            this.content.forEach(function (e, i) {
          ...
          cc.Class({
            ...
            onLoad: function () {
              ;(this.page = cc.instantiate(this.page)),
                ...
                (this.lichSuChuyen =
                  this.lichSuChuyen.getComponent("LichSuChuyen")),
                (this.lichSuBank = this.lichSuBank.getComponent("LichSuBank")),
                (this.body = [
                  this.lichSuNap.node,
                  this.lichSuRut.node,
                  this.lichSuChuyen.node,
                  this.lichSuBank.node,
                ]),
                (this.header = this.header.children.map(function (t) {
                  return t.getComponent("itemContentMenu")
                }))
            ...
            onData: function (t) {
              this.page.onSet(t.page, t.kmess, t.total),
                ...
                void 0 !== t.chuyen_red &&
                  this.lichSuChuyen.onData(t.chuyen_red),
        ...
        cc._RF.push(e, "738b2QcBnhOn7bLV2UFI4l9", "MainAudio"),
          cc.Class({
            ...
            properties: {
              ...
              thongbao_jackpot: { default: null, type: cc.AudioClip },
              jackpot: { default: null, type: cc.AudioClip },
              bigWin: { default: null, type: cc.AudioClip },
              moneywin: { default: null, type: cc.AudioClip },
              bonus: { default: null, type: cc.AudioClip },
              megaWin: { default: null, type: cc.AudioClip },
              winHu: { default: null, type: cc.AudioClip },
              mainBackground: { default: null, type: cc.AudioSource },
              fishHall: { default: null, type: cc.AudioSource },
              fishBG1: { default: null, type: cc.AudioSource },
              fishBG2: { default: null, type: cc.AudioSource },
              bgSlot1: { default: null, type: cc.AudioSource },
              bgSlot2: { default: null, type: cc.AudioSource },
            },
            _playSFX: function (t) {
              cc.RedT.IS_SOUND && cc.audioEngine.playEffect(t, !1)
            },
    ...
    MainGame: [
      function (t, e, i) {
        ...
        cc.Class({
          ...
          properties: {
            MenuRoom: d,
            avatars: { default: [], type: cc.SpriteFrame },
            PrefabT: { default: [], type: cc.Prefab },
            header: c,
            news: cc.Node,
            newsContents: h,
            bgLoading: r,
          ...
          onLoad: function () {
            this.dialog.init(),
              ...
              (this.iconCandyTemp =
                this.iconCandyTemp.getComponent("iconGameHu")),
              (this.iconVQRedTemp =
                this.iconVQRedTemp.getComponent("iconGameHu")),
              (this.iconLongLanTemp =
                this.iconLongLanTemp.getComponent("iconGameHu")),
              (this.iconZeusTemp =
                this.iconZeusTemp.getComponent("iconGameHu")),
              cc.RedT.IS_LOGIN
                ? (cc.RedT.send({ scene: "home" }),
                  this.header.reset(),
                  (this.header.userName.string = cc.RedT.user.name),
                  (this.dialog.profile.CaNhan.username.string =
                    cc.RedT.user.name),
                  (this.header.userRed.string =
                    this.dialog.profile.KetSat.redHT.string =
                      n.numberWithCommas(cc.RedT.user.red)),
                  (this.dialog.profile.KetSat.redKet.string =
                    n.numberWithCommas(cc.RedT.user.ketSat)),
                  (this.dialog.profile.CaNhan.UID.string = cc.RedT.user.UID),
                  (this.dialog.profile.CaNhan.joinedOn.string =
                    n.getStringDateByTime(cc.RedT.user.joinedOn)),
                  (this.dialog.profile.CaNhan.phone.string =
                    cc.RedT.user.phone),
                  this.dialog.profile.BaoMat.DangKyOTP.statusOTP(
                    !n.isEmpty(cc.RedT.user.phone)
                  ),
                  n.isEmpty(cc.RedT.user.phone)
                    ? (this.dialog.profile.CaNhan.phoneStatus.string = "")
                    : ((this.dialog.profile.BaoMat.DangKyOTP.labelPhone.string =
                        cc.RedT.user.phone),
                      cc.RedT.user.veryphone
                        ? ((this.dialog.profile.CaNhan.phoneStatus.string =
                            "\u0110\xe3 X\xe1c Th\u1ef1c"),
                          (this.dialog.profile.CaNhan.phoneStatus.node.color =
                            this.dialog.profile.CaNhan.phoneStatus.node.color.fromHEX(
                              "06B30D"
                            )))
                        : ((this.dialog.profile.CaNhan.phoneStatus.string =
                            "Ch\u01b0a X\xe1c Th\u1ef1c"),
              ...
              (null == localStorage.getItem("SOUND_BACKGROUND") ||
                cc.RedT.isSoundBackground()) &&
            ...
            cc.RedT.IS_LOGIN ||
              setTimeout(
                function () {
                  ...
                  t &&
                    e &&
                    this.autoAuth({ authentication: { id: t, token: e } })
                }.bind(this),
                300
              )
          },
          ...
          onData: function (t) {
            this.dataOn &&
              ...
              void 0 !== t.user &&
                (cc.RedT.userData(t.user), this.dataUser(t.user)),
              void 0 !== t.mini && cc.RedT.MiniPanel.onData(t.mini),
              void 0 !== t.TopHu &&
              ...
              void 0 !== t.news &&
                this.newsOn &&
                this.newsContents.onData(t.news),
              ...
              void 0 !== t.event &&
                this.dialog &&
                this.dialog.DEvent.onData(t.event),
              void 0 !== t.vipp &&
                cc.RedT.MiniPanel.Dialog.VipPoint.onData(t.vipp),
            ...
            ;(t >>= 0),
              void 0 !== cc.RedT.avatars[t]
                ? ((this.header.avatar.spriteFrame = cc.RedT.avatars[t]),
                  (this.dialog.profile.CaNhan.avatar.spriteFrame =
                    cc.RedT.avatars[t]))
          ...
          dataUser: function (t) {
            void 0 !== t.avatar && this.setAvatar(t.avatar),
              ...
              void 0 !== t.red &&
                (this.header.userRed.string =
                  this.dialog.profile.KetSat.redHT.string =
                    n.numberWithCommas(t.red)),
              void 0 !== t.ketSat &&
                (this.dialog.profile.KetSat.redKet.string = n.numberWithCommas(
                  t.ketSat
                )),
              void 0 !== t.UID &&
                (this.dialog.profile.CaNhan.UID.string = t.UID),
              void 0 !== t.phone &&
              ...
              void 0 !== t.joinedOn &&
                (this.dialog.profile.CaNhan.joinedOn.string =
                  n.getStringDateByTime(t.joinedOn)),
              void 0 !== t.level &&
          ...
          noticeCopy: function () {
            ...
            ;(t.getComponent("mini_warning").text.string =
              "\u0110\xe3 copy n\u1ed9i dung \u0111\u01b0\u1ee3c ch\u1ecdn"),
              this.node.addChild(t)
          },
          audioClick: function () {
            cc.RedT.audio.playClick()
          ...
          android: function () {
            cc.sys.openURL(this.url + "/" + this.fileAPK)
          },
          telegram: function () {
            ...
            if (void 0 !== cc.RedT.setting.topHu.data) {
              Promise.all(
                ...
                s - i[0].bet != 0 &&
                  (n.numberTo(
                    t.iconVQRed.hu100,
                    n.getOnlyNumberInString(t.iconVQRed.hu100.string),
                    i[0].bet,
                    4900,
                    !0
                  ),
                  n.numberTo(
                    t.iconVQRedTemp.hu100,
                    n.getOnlyNumberInString(t.iconVQRedTemp.hu100.string),
                    i[0].bet,
                    4900,
                    !0
                  )),
                  a - o[0].bet != 0 &&
                    (n.numberTo(
                      t.iconVQRed.hu1k,
                      n.getOnlyNumberInString(t.iconVQRed.hu1k.string),
                      o[0].bet,
                      4900,
                      !0
                    ),
                    n.numberTo(
                      t.iconVQRedTemp.hu1k,
                      n.getOnlyNumberInString(t.iconVQRedTemp.hu1k.string),
                      o[0].bet,
                      4900,
                      !0
                    )),
                  h - c[0].bet != 0 &&
                    (n.numberTo(
                      t.iconVQRed.hu10k,
                      n.getOnlyNumberInString(t.iconVQRed.hu10k.string),
                      c[0].bet,
                      4900,
                      !0
                    ),
                    n.numberTo(
                      t.iconVQRedTemp.hu10k,
                      n.getOnlyNumberInString(t.iconVQRedTemp.hu10k.string),
                      c[0].bet,
                      4900,
                      !0
                    ))
                ...
                Promise.all(
                  ...
                  s - i[0].bet != 0 &&
                    (n.numberTo(
                      t.iconCandy.hu100,
                      n.getOnlyNumberInString(t.iconCandy.hu100.string),
                      i[0].bet,
                      4900,
                      !0
                    ),
                    n.numberTo(
                      t.iconCandyTemp.hu100,
                      n.getOnlyNumberInString(t.iconCandyTemp.hu100.string),
                      i[0].bet,
                      4900,
                      !0
                    )),
                    a - o[0].bet != 0 &&
                      (n.numberTo(
                        t.iconCandy.hu1k,
                        n.getOnlyNumberInString(t.iconCandy.hu1k.string),
                        o[0].bet,
                        4900,
                        !0
                      ),
                      n.numberTo(
                        t.iconCandyTemp.hu1k,
                        n.getOnlyNumberInString(t.iconCandyTemp.hu1k.string),
                        o[0].bet,
                        4900,
                        !0
                      )),
                    h - c[0].bet != 0 &&
                      (n.numberTo(
                        t.iconCandy.hu10k,
                        n.getOnlyNumberInString(t.iconCandy.hu10k.string),
                        c[0].bet,
                        4900,
                        !0
                      ),
                      n.numberTo(
                        t.iconCandyTemp.hu10k,
                        n.getOnlyNumberInString(t.iconCandyTemp.hu10k.string),
                        c[0].bet,
                        4900,
                        !0
                      ))
                ...
                Promise.all(
                  ...
                  s - i[0].bet != 0 &&
                    (n.numberTo(
                      t.iconZeus.hu100,
                      n.getOnlyNumberInString(t.iconZeus.hu100.string),
                      i[0].bet,
                      4900,
                      !0
                    ),
                    n.numberTo(
                      t.iconZeusTemp.hu100,
                      n.getOnlyNumberInString(t.iconZeusTemp.hu100.string),
                      i[0].bet,
                      4900,
                      !0
                    )),
                    a - o[0].bet != 0 &&
                      (n.numberTo(
                        t.iconZeus.hu1k,
                        n.getOnlyNumberInString(t.iconZeus.hu1k.string),
                        o[0].bet,
                        4900,
                        !0
                      ),
                      n.numberTo(
                        t.iconZeusTemp.hu1k,
                        n.getOnlyNumberInString(t.iconZeusTemp.hu1k.string),
                        o[0].bet,
                        4900,
                        !0
                      )),
                    h - c[0].bet != 0 &&
                      (n.numberTo(
                        t.iconZeus.hu10k,
                        n.getOnlyNumberInString(t.iconZeus.hu10k.string),
                        c[0].bet,
                        4900,
                        !0
                      ),
                      n.numberTo(
                        t.iconZeusTemp.hu10k,
                        n.getOnlyNumberInString(t.iconZeusTemp.hu10k.string),
                        c[0].bet,
                        4900,
                        !0
                      ))
                ...
                Promise.all(
                  ...
                  s - i[0].bet != 0 &&
                    (n.numberTo(
                      t.iconLongLan.hu100,
                      n.getOnlyNumberInString(t.iconLongLan.hu100.string),
                      i[0].bet,
                      4900,
                      !0
                    ),
                    n.numberTo(
                      t.iconLongLanTemp.hu100,
                      n.getOnlyNumberInString(t.iconLongLanTemp.hu100.string),
                      i[0].bet,
                      4900,
                      !0
                    )),
                    a - o[0].bet != 0 &&
                      (n.numberTo(
                        t.iconLongLan.hu1k,
                        n.getOnlyNumberInString(t.iconLongLan.hu1k.string),
                        o[0].bet,
                        4900,
                        !0
                      ),
                      n.numberTo(
                        t.iconLongLanTemp.hu1k,
                        n.getOnlyNumberInString(t.iconLongLanTemp.hu1k.string),
                        o[0].bet,
                        4900,
                        !0
                      )),
                    h - c[0].bet != 0 &&
                      (n.numberTo(
                        t.iconLongLan.hu10k,
                        n.getOnlyNumberInString(t.iconLongLan.hu10k.string),
                        c[0].bet,
                        4900,
                        !0
                      ),
                      n.numberTo(
                        t.iconLongLanTemp.hu10k,
                        n.getOnlyNumberInString(t.iconLongLanTemp.hu10k.string),
                        c[0].bet,
                        4900,
                        !0
                      ))
        ...
        cc.Class({
          ...
          get_data: function () {
            ...
            if (!this.RedT.isSpin) {
              var e = {}
              ;(e[this.select] = t),
                cc.RedT.send({ g: { megaj: { history: e } } })
            }
          },
          onData: function (t) {
              ...
              this.nhanve.forEach(
                function (e, i) {
                  ...
                  if (void 0 !== o) {
                    ...
                    var c = e.status.node
                    o.status
                      ? (c.color = c.color.fromHEX("#248A0A"))
                      : (c.color = c.color.fromHEX("#BB0B0B"))
        ...
        cc.Class({
          ...
          init: function (t) {
            ;(this.RedT = t),
              ...
              "true" == localStorage.getItem("MegaJackpot") &&
                (this.node.active = !0),
              void 0 !== cc.RedT.setting.MegaJackpot.game
                ? cc.RedT.setting.MegaJackpot.game !== this.game &&
                  this.changerGame(null, cc.RedT.setting.MegaJackpot.game)
                : (cc.RedT.setting.MegaJackpot.game = this.game = "100"),
              void 0 !== cc.RedT.setting.MegaJackpot.position &&
          ...
          changerGame: function (t, e) {
            ;(cc.RedT.setting.MegaJackpot.game = this.game = e),
              ...
              (this.luot.string =
                cc.RedT.setting.MegaJackpot.users[e] + " L\u01b0\u1ee3t"),
          ...
          spin: function () {
            this.spinNode.pauseSystemEvents(),
              ...
              this.isSpin || cc.RedT.send({ g: { megaj: { spin: this.game } } })
          },
          onData: function (t) {
          ...
          updateStatus: function (t) {
            if (!0 === t.status) {
              ...
              var e = cc
                  .rotateTo(10, -(2520 + t.data.position))
          ...
          updateKQ: function () {
            if (5 === this.oldData.kq);
              ...
              var t = new cc.Node()
              t.addComponent(cc.Label),
                ((t = t.getComponent(cc.Label)).string = n.numberWithCommas(
                  this.oldData.data.thuong
                )),
                (t.font = cc.RedT.util.fontCong),
                (t.lineHeight = 130),
                (t.fontSize = 20),
        ...
        cc._RF.push(e, "b4e69eoVuxHQo0om02/ZxFC", "MenuRoom"),
          cc.Class({
            ...
            properties: {
              ...
              hall: { default: [], type: cc.SpriteFrame },
              rooms: { default: [], type: cc.Sprite },
              table1: { default: [], type: cc.SpriteFrame },
        ...
        var c =
          (o(
            (n = {
              ...
              TITLE_FAILED: "L\u1ed7i",
              TIME_OUT_LOADING:
                "C\xf3 l\u1ed7i trong qu\xe1 tr\xecnh th\u1ef1c hi\u1ec7n, vui l\xf2ng th\u1eed l\u1ea1i",
              CONNECT_SFS_ERROR:
                "Kh\xf4ng th\u1ec3 k\u1ebft n\u1ed1i t\u1edbi Server",
              MISSING_INFO:
                "Vui l\xf2ng nh\u1eadp \u0111\u1ea7y \u0111\u1ee7 c\xe1c th\xf4ng tin",
              SUCCESS: "Th\xe0nh c\xf4ng",
              FAILURE: "Th\u1ea5t b\u1ea1i",
              VERSION: "Phi\xean b\u1ea3n: {0}",
              CONTACT: "{0}",
              OTP_FIRST_ACCOUNT:
                "K\xedch ho\u1ea1t s\u1ed1 \u0111i\u1ec7n tho\u1ea1i b\u1ea3o m\u1eadt \u0111\u1ec3 b\u1ea3o v\u1ec7 t\xe0i kho\u1ea3n b\u1ea1n nh\xe9!",
              OTP_ACTIVE_ACCOUNT:
                "Vui l\xf2ng so\u1ea1n tin <color=yellow>{0}</color> g\u1eedi <color=yellow>{1}</color> \u0111\u1ec3 k\xedch ho\u1ea1t OTP",
              OTP_FORGET_PASSWORD:
                "B\u01b0\u1edbc 1: So\u1ea1n tin <color=yellow>{0}</color> g\u1eedi <color=yellow>{1}</color> \u0111\u1ec3 l\u1ea5y m\xe3 x\xe1c th\u1ef1c",
              LOGIN_TITLE: "\u0110\u0103ng nh\u1eadp",
              LOGIN_MISSING_USERNAME:
                "Thi\u1ebfu th\xf4ng tin t\xe0i kho\u1ea3n",
              LOGIN_MISSING_PASSWORD:
                "Thi\u1ebfu th\xf4ng tin m\u1eadt kh\u1ea9u",
              LOGIN_MISSING_CAPTCHA:
                "Thi\u1ebfu th\xf4ng tin m\xe3 x\xe1c nh\u1eadn",
              LOGIN_SECURITY_SMS:
                "\u0110\u1ec3 \u0111\u0103ng k\xfd b\u1ea3o m\u1eadt \u0111\u0103ng nh\u1eadp vui l\xf2ng so\u1ea1n tin <color=yellow>{0}</color> g\u1eedi <color=yellow>{1}</color>\n\u0110\u1ec3 h\u1ee7y b\u1ea3o m\u1eadt \u0111\u0103ng nh\u1eadp vui l\xf2ng so\u1ea1n tin <color=yellow>{2}</color> g\u1eedi <color=yellow>{3}</color>",
              LOGIN_SECURITY_SMS_2:
                "So\u1ea1n tin <color=yellow>{0}</color> g\u1eedi <color=yellow>{1}</color> \u0111\u1ec3 l\u1ea5y m\xe3 OTP",
              SECURITY_GAME: "Qu\u1ea3n l\xfd game",
              TIME_LOGIN:
                "B\u1ea1n \u0111\xe3 \u0111\u0103ng nh\u1eadp qu\xe1 nhi\u1ec1u\nVui l\xf2ng th\u1eed l\u1ea1i sau \xedt ph\xfat",
              REGISTER_TITLE: "\u0110\u0103ng k\xfd",
              REGISTER_MISSING_USERNAME:
                "Vui l\xf2ng nh\u1eadp t\xean t\xe0i kho\u1ea3n",
              REGISTER_MISSING_PASSWORD:
                "Vui l\xf2ng nh\u1eadp m\u1eadt kh\u1ea9u",
              REGISTER_MISSING_REPASSWORD:
                "Vui l\xf2ng nh\u1eadp m\u1eadt kh\u1ea9u x\xe1c nh\u1eadn",
              REGISTER_REPASSWORD_NOT_CORRECT:
                "Nh\u1eadp l\u1ea1i m\u1eadt kh\u1ea9u ch\u01b0a ch\xednh x\xe1c. Vui l\xf2ng th\u1eed l\u1ea1i",
              REGISTER_NOT_AGREE_TERM:
                "Vui l\xf2ng x\xe1c nh\u1eadn l\u1ea1i c\xe1c \u0111i\u1ec1u kho\u1ea3n s\u1eed d\u1ee5ng",
              FORGET_PASSWORD_TITLE: "Qu\xean m\u1eadt kh\u1ea9u",
              FORGET_PASSWORD_MISSING_USERNAME_EMAIL:
                "Vui l\xf2ng nh\u1eadp \u0111\u1ea7y \u0111\u1ee7 t\xean t\xe0i kho\u1ea3n v\xe0 Email",
              FORGET_PASSWORD_NOT_SUPPORT_FORGET_PASSWORD_BY_PHONE:
                "Ch\xfang t\xf4i hi\u1ec7n ch\u01b0a h\u1ed7 tr\u1ee3 l\u1ea5y l\u1ea1i m\u1eadt kh\u1ea9u b\u1eb1ng s\u1ed1 \u0111i\u1ec7n tho\u1ea1i",
              FORGET_PASSWORD_SUCCESS:
                "G\u1eedi email th\xe0nh c\xf4ng. Vui l\xf2ng ki\u1ec3m tra email \u0111\u1ec3 l\u1ea5y th\xf4ng tin v\u1ec1 m\u1eadt kh\u1ea9u m\u1edbi",
              FORGET_PASSWORD_RE_PASSWORD_NOT_CORRECT:
                "M\u1eadt kh\u1ea9u x\xe1c nh\u1eadn kh\xf4ng ch\xednh x\xe1c",
              CHANGE_PASSWORD_TITLE: "\u0110\u1ed5i m\u1eadt kh\u1ea9u",
              CHANGE_PASSWORD_RE_PASSWORD_NOT_CORRECT:
                "M\u1eadt kh\u1ea9u x\xe1c nh\u1eadn kh\xf4ng ch\xednh x\xe1c",
              CHANGE_PASSWORD_GET_OTP:
                "B\u1ea1n vui l\xf2ng s\u1eed d\u1ee5ng OTP App \u0111\u1ec3 nh\u1eadn OTP ho\u1eb7c li\xean h\u1ec7 v\u1edbi QTV \u0111\u1ec3 bi\u1ebft th\xeam th\xf4ng tin",
              SET_NICKNAME_TITLE: "T\u1ea1o nh\xe2n v\u1eadt",
              SET_NICKNAME_NICKNAME_NOT_EMPTY:
                "T\xean nh\u1eadn v\u1eadt kh\xf4ng \u0111\u01b0\u1ee3c tr\u1ed1ng",
              OTP_NOT_EMPTY:
                "M\xe3 OTP kh\xf4ng \u0111\u01b0\u1ee3c ph\xe9p tr\u1ed1ng",
              NICKNAME_DIFFERENT_USERNAME:
                "T\xean nh\xe2n v\u1eadt kh\xf4ng \u0111\u01b0\u1ee3c tr\xf9ng v\u1edbi t\xe0i kho\u1ea3n",
              OTP_LOGIN_TITLE: "B\u1ea3o m\u1eadt \u0111\u0103ng nh\u1eadp",
              REGISTER_GIFTCODE_WELCOME:
                "Xin ch\xe0o <color=yellow>{0}</color>",
              UPDATE_DIAMOND:
                "B\u1ea1n \u0111\u01b0\u1ee3c t\u1eb7ng KIM C\u01af\u01a0NG. Xem ngay t\u1ea1i S\u1ef0 KI\u1ec6N L\xcaN \u0110\u1edcI SI\xcaU XE",
              ...
              FORMAT_PHONE_NOT_CORRECT:
                "\u0110\u1ecbnh d\u1ea1ng s\u1ed1 \u0111i\u1ec7n tho\u1ea1i kh\xf4ng ch\xednh x\xe1c",
              FORMAT_DOB_NOT_CORRECT:
                "\u0110\u1ecbnh d\u1ea1ng ng\xe0y sinh kh\xf4ng ch\xednh x\xe1c",
              FORMAT_EMAIL_NOT_CORRECT:
                "\u0110\u1ecbnh d\u1ea1ng Email kh\xf4ng ch\xednh x\xe1c",
              INFO_DOB: "{0}/{1}/{2}",
              PLAYER_INFO_TITLE: "Th\xf4ng tin ng\u01b0\u1eddi ch\u01a1i",
              MAIL_TITLE: "H\xf2m th\u01b0",
              MAIL_DETAIL_TITLE:
                "Ngu\u1eddi g\u1eedi: {0} - Th\u1eddi gian: {1}",
              MAIL_NOTIFICATION: "B\u1ea1n c\xf3 tin nh\u1eafn m\u1edbi",
              RECHARGE_MONEY_SUCCESS:
                "B\u1ea1n \u0111\xe3 n\u1ea1p th\xe0nh c\xf4ng {0} {1}",
              ...
              RECHARGE_GOLD_HISTORY_NOTE:
                "S\u1ed1 Xu nh\u1eadn \u0111\u01b0\u1ee3c: {0}",
              RECHARGE_SMS_NOTE:
                "<color=#A17E1A><i>N\u1ea1p {0} nh\u1eadn ngay {1} KAY</i></c>",
              RECHARGE_SMS_MSG:
                "So\u1ea1n <color=yellow>{0}</color> g\u1eedi <color=green>{1}</color>",
              ...
              NUMBER_CARDS_LARGER_ZERO:
                "S\u1ed1 l\u01b0\u1ee3ng th\u1ebb ph\u1ea3i > 0",
              TRANSFER_TITLE: "Chuy\u1ec3n kho\u1ea3n",
              VALUE_LARGER_ZERO: "S\u1ed1 KAY ph\u1ea3i > 0",
              RE_NICKNAME_NOT_CORRECT:
                "X\xe1c nh\u1eadn nickname kh\xf4ng ch\xednh x\xe1c",
              TRANSFER_LOCKED:
                "Ch\u1ee9c n\u0103ng chuy\u1ec3n kho\u1ea3n \u0111ang t\u1ea1m kh\xf3a",
              TRANSFER_OTP:
                "So\u1ea1n tin <color=yellow>{0}</color> g\u1eedi <color=yellow>{1}</color>",
              SAFE_TITLE: "K\xe9t s\u1eaft",
              SAFE_NOT_ACTIVE_PHONE:
                "Vui l\xf2ng b\u1ea3o m\u1eadt t\xe0i kho\u1ea3n b\u1eb1ng S\u1ed1 \u0111i\u1ec7n tho\u1ea1i \u0111\u1ec3 r\xfat ti\u1ec1n",
              SAFE_GET_OTP:
                "So\u1ea1n tin: <color = #F0FF40>{0}</color> g\u1eedi <color = #F0FF40>{1}</color> \u0111\u1ec3 l\u1ea5y m\xe3 x\xe1c th\u1ef1c",
              HISTORY_TITLE: "L\u1ecbch s\u1eed",
              TOP_TITLE: "B\u1ea3ng x\u1ebfp h\u1ea1ng",
              GIFTCODE_TITLE: "Gift Code",
              GIFTCODE_NOT_ACTIVE:
                "Vui l\xf2ng b\u1ea3o m\u1eadt \u0111\u1ec3 s\u1eed d\u1ee5ng Gift Code",
              CAPCHA_NOT_CORRECT:
                "M\xe3 x\xe1c nh\u1eadn kh\xf4ng ch\xednh x\xe1c",
              ...
              CHAT_SLOT_2_MESSAGE:
                "<color=#DE9100><b>{0}: </b></color><color=#C3C2C3>{1}</color>",
              TAIXIU_YOU_ONLE_BET_A_DOOR:
                "B\u1ea1n ch\u1ec9 \u0111\u01b0\u1ee3c \u0111\u1eb7t m\u1ed9t c\u1eeda",
              JOIN_ROOM_TITLE: "Ch\u1ecdn ph\xf2ng",
              NOT_ENOUGH_MONEY_TO_JOIN_GAME:
                "B\u1ea1n c\u1ea7n t\u1ed1i thi\u1ec3u {0} {1} \u0111\u1ec3 tham gia ch\u01a1i game",
              NOT_ENOUGH_MONEY_TO_STAY_GAME:
                "B\u1ea1n c\u1ea7n {0} {1} \u0111\u1ec3 ti\u1ebfp t\u1ee5c ch\u01a1i game!",
              JOIN_ROOM_ERROR:
                "Ph\xf2ng ch\u01a1i hi\u1ec7n t\u1ea1i \u0111ang b\u1ecb kh\xf3a",
              ...
              BOM: "Thi\xean H\xe0",
              INVITE_MESSAGE:
                "Ng\u01b0\u1eddi ch\u01a1i <color=green>{0}</color> m\u1eddi b\u1ea1n v\xe0o game <color=green>{1}</color>\nM\u1ee9c c\u01b0\u1ee3c: <color=yellow>{2} {3}</color>",
              GAME_DESCRIBE_TABLE_NAME:
                "{0} - B\xe0n {1} - Phi\xean ch\u01a1i {2}",
              GAME_DESCRIBE_TABLE_BET: "M\u1ee9c c\u01b0\u1ee3c: {0} {1}",
              REQUEST_LEFT_ROOM:
                "\u0110\u0103ng k\xfd r\u1eddi b\xe0n th\xe0nh c\xf4ng",
              IGNORE_REQUEST_LEFT_ROOM:
                "H\u1ee7y r\u1eddi b\xe0n th\xe0nh c\xf4ng",
              BACAY_WIN_ALL: "B\u1eaeT C\u1ea2 L\xc0NG",
              BACAY_LOSE_ALL: "PH\xc1T L\u01af\u01a0NG",
              BACAY_BET_PRIVATE_BUTTON:
                "\u0110\xc1NH BI\xcaN T\u1ea4T C\u1ea2 ({0})",
              MAU_BINH_BINH_LUNG_NOT_COMPLETE:
                "Binh l\u1ee7ng kh\xf4ng th\u1ec3 ho\xe0n th\xe0nh",
              MAU_BINH_KHONG_HOP_LE: "KH\xd4NG H\u1ee2P L\u1ec6",
              MAU_BINH_THUNG_PHA_SANH_LON:
                "TH\xd9NG PH\xc1 S\u1ea2NH \u0110\u1ea0I",
              ...
              MAU_BINH_THUNG_PHA_SANH_CHI_DAU:
                "TH\xd9NG PH\xc1 S\u1ea2NH CHI \u0110\u1ea6U",
              MAU_BINH_TU_QUY_CHI_DAU: "T\u1ee8 QU\xdd CHI \u0110\u1ea6U",
              MAU_BINH_THUNG_PHA_SANH_CHI_GIUA:
                "TH\xd9NG PH\xc1 S\u1ea2NH CHI GI\u1eeeA",
              ...
              TLMN_THOI_BON_DOI_THONG:
                "TH\u1ed0I B\u1ed0N \u0110\xd4I TH\xd4NG",
              ...
              XOC_DIA_START_REGISTER_HOST:
                "B\u1eaft \u0111\u1ea7u \u0111\u0103ng k\xfd l\xe0m host",
              XOC_DIA_WAIT_NEXT_GAME:
                "Ch\u1edd \u0111\u1ec3 b\u1eaft \u0111\u1ea7u v\xe1n ch\u01a1i m\u1edbi",
              XOC_DIA_START_BET: "Vui l\xf2ng \u0111\u1eb7t c\u01b0\u1ee3c",
              XOC_DIA_BUY_SELL_DOOR: "Th\u1eddi gian mua b\xe1n c\u1eeda",
              XOC_DIA_NOT_TIME_TO_BET:
                "Kh\xf4ng ph\u1ea3i th\u1eddi gian \u0111\u1ec3 \u0111\u1eb7t c\u1eeda",
              XOC_DIA_NOT_SELECT_CHIP:
                "B\u1ea1n ch\u01b0a ch\u1ecdn ti\u1ec1n c\u01b0\u1ee3c",
              XOC_DIA_BALANCE_DOOR: "C\xe2n c\u1eeda",
              XOC_DIA_RESULT: "V\xe1n ch\u01a1i k\u1ebft th\xfac",
              XOC_DIA_NOT_BET_NO_HOST:
                "Kh\xf4ng th\u1ec3 \u0111\u1eb7t c\u1eeda n\xe0y khi kh\xf4ng c\xf3 C\xe1i",
              ...
              PHOM_PLEASE_SELECT_CARDS_HA:
                "Vui l\xf2ng ch\u1ecdn ph\u1ecfm c\u1ea7n h\u1ea1",
              ...
              SLOT_NOT_CHANGE_BET:
                "Tr\u1ea1ng th\xe1i hi\u1ec7n t\u1ea1i kh\xf4ng th\u1ec3 thay \u0111\u1ed5i m\u1ee9c c\u01b0\u1ee3c",
              SLOT_NOT_AUTO_SPIN:
                "Tr\u1ea1ng th\xe1i hi\u1ec7n t\u1ea1i kh\xf4ng th\u1ec3 t\u1ef1 \u0111\u1ed9ng quay",
              SLOT_NOT_TEST:
                "Tr\u1ea1ng th\xe1i hi\u1ec7n t\u1ea1i kh\xf4ng th\u1ec3 ch\u01a1i th\u1eed",
              SLOT_BONUS_GAME_FINISH:
                "Ch\xfac m\u1eebng b\u1ea1n nh\u1eadn \u0111\u01b0\u1ee3c <color=yellow>{0} KAY </color>",
              SLOT_CANCEL_BACK:
                "Vui l\xf2ng \u0111\u1ee3i v\xf2ng ch\u01a1i k\u1ebft th\xfac",
              SLOT_NOT_CHANGE_SELECT_LINE:
                "Tr\u1ea1ng th\xe1i hi\u1ec7n t\u1ea1i kh\xf4ng th\u1ec3 ch\u1ecdn d\xf2ng c\u01b0\u1ee3c",
              PLAYING_NOT_CHANGE_BET:
                "Ch\u1edd h\u1ebft l\u01b0\u1ee3t \u0111\u1ec3 \u0111\u1ed5i c\u1eeda \u0111\u1eb7t",
              PLAYING_NOT_CHANGE_MONEY_TYPE:
                "Ch\u1edd h\u1ebft l\u01b0\u1ee3t \u0111\u1ec3 \u0111\u1ed5i lo\u1ea1i ti\u1ec1n",
              AUTO_SPIN_NOT_CHANGE_BET:
                "\u0110ang t\u1ef1 \u0111\u1ed9ng quay kh\xf4ng \u0111\u01b0\u1ee3c thay \u0111\u1ed5i c\u1eeda \u0111\u1eb7t",
              AUTO_SPIN_NOT_CHANGE_MONEY_TYPE:
                "\u0110ang t\u1ef1 \u0111\u1ed9ng quay kh\xf4ng \u0111\u01b0\u1ee3c thay \u0111\u1ed5i lo\u1ea1i ti\u1ec1n",
              SPIN_TOO_FAST: "Quay qu\xe1 nhanh",
              GAME_STOP_SPIN:
                "Vui l\xf2ng ch\u1edd v\xf2ng quay k\u1ebft th\xfac",
              MINIGAME_ID: "#{0}",
              TAIXIU_HISTORIES_DETAIL: "Phi\xean ch\u01a1i {0} - {1}",
              TAIXIU_BALANCE_DOOR: "Tr\u1ea3 ti\u1ec1n c\xe2n c\u1eeda",
              TAIXIU_YOU_NOT_BET:
                "Vui l\xf2ng nh\u1eadp ti\u1ec1n c\u01b0\u1ee3c",
              TAIXIU_CHAIN_WIN: "Chu\u1ed7i th\u1eafng: {0}",
              TAIXIU_CHAIN_LOSE: "Chu\u1ed7i thua: {0}",
              TRENDUOI_CLICK_PLAY:
                "B\u1ea5m v\xe0o PLAY \u0111\u1ec3 b\u1eaft \u0111\u1ea7u ch\u01a1i",
              TRENDUOI_STOP_SPINING:
                "Vui l\xf2ng ch\u1edd v\xf2ng quay k\u1ebft th\xfac",
              TRENDUOI_FINISH: "K\u1ebft th\xfac",
              TRENDUOI_LOSE:
                "B\u1ea1n \u0111\xe3 thua. Ch\xfac b\u1ea1n may m\u1eafn l\u1ea7n sau",
          ...
          o(
            n,
            "DRAGON_TIGER_CHAIN",
            "S\u1ef1 ki\u1ec7n \u0111ua d\xe2y long h\u1ed5"
          ),
          o(
            n,
            "DRAGON_TIGER_NO_BET_SELECTED",
            "Vui l\xf2ng ch\u1ecdn m\u1ee9c c\u01b0\u1ee3c"
          ),
          o(n, "MINI_GAME_RANK_TITLE", "B\u1ea2NG X\u1ebeP H\u1ea0NG"),
          o(
            n,
            "MINI_GAME_RANK_TITLE_TAI_XIU",
            "B\u1ea2NG X\u1ebeP H\u1ea0NG T\xc0I X\u1ec8U"
          ),
          o(
            n,
            "MINI_GAME_RANK_TITLE_CHAN_LE",
            "B\u1ea2NG X\u1ebeP H\u1ea0NG CH\u1eb4N L\u1eba"
          ),
          o(
            n,
            "DIAMOND_NO_LINE_SELECTED",
            "B\u1ea1n ch\u01b0a ch\u1ecdn d\xf2ng \u0111\u1eb7t c\u01b0\u1ee3c"
          ),
          o(
            n,
            "PIRATE_NO_LINE_SELECTED",
            "B\u1ea1n ch\u01b0a ch\u1ecdn d\xf2ng \u0111\u1eb7t c\u01b0\u1ee3c"
          ),
          o(
            n,
            "LUCKY_WHEEL_IS_SPINING",
            "Vui l\xf2ng ch\u1edd v\xf2ng quay k\u1ebft th\xfac"
          ),
          o(
            n,
            "LUCKY_WHEEL_CONGRATULATION",
            "Ch\xfac m\u1eebng b\u1ea1n nh\u1eadn \u0111\u01b0\u1ee3c ph\u1ea7n th\u01b0\u1edfng t\u1eeb V\xf2ng Quay May M\u1eafn"
          ),
          o(n, "FIREFISH_MIN_BET", "MIN = {0} {1}"),
          o(
            n,
            "FIREFISH_FISHED",
            "Ng\u01b0\u1eddi ch\u01a1i <color=#FA3030>{0}</color> v\u1eeba gi\u1ebft ch\u1ebft <color=#56EA00>{1}</color> nh\u1eadn \u0111\u01b0\u1ee3c <color=#FAFF1A>{2}</color> {3}"
          ),
          o(
            n,
            "FORGET_PASSWORD_NOTIFICATION",
            "Vui l\xf2ng li\xean h\u1ec7 v\u1edbi BQT qua Fanpage ho\u1eb7c Hotline: 097 171 4012 \u0111\u1ec3 \u0111\u01b0\u1ee3c h\u1ed7 tr\u1ee3 ngay b\u1ea1n nh\xe9!"
          ),
          o(
            n,
            "SLOT_NOT_CHANGE_SPIN",
            "Vui l\xf2ng \u0111\u1ee3i v\xf2ng ch\u01a1i k\u1ebft th\xfac"
          ),
          o(
            n,
            "SLOT2_NOT_SELECT_LINE",
            "Vui l\xf2ng ch\u1ecdn d\xf2ng c\u01b0\u1ee3c."
          ),
          o(
            n,
            "SLOT2_AUTOSPIN_NOT_CHANGE",
            "\u0110ang \u1edf ch\u1ebf \u0111\u1ed9 quay t\u1ef1 \u0111\u1ed9ng. B\u1ea1n kh\xf4ng th\u1ec3 th\u1ef1c hi\u1ec7n thao th\xe1c n\xe0y"
          ),
          o(
            n,
            "SLOT2_RANK_1",
            "Ch\xfac m\u1eebng <color = #F7A200>{0}</color> \u0111\xe3 d\xe0nh \u0111\u01b0\u1ee3c H\u0169 <color = #F7A200>{1}</color> KAY v\xe0o l\xfac {2}"
          ),
          o(
            n,
            "SLOT2_RANK_2",
            "TK <color = #F7A200>{0}</color> th\u1eafng <color = #F7A200>{1}</color> KAY {2} tr\u01b0\u1edbc"
          ),
          o(
            n,
            "SLOT2_HISTORY",
            "B\u1ea1n ch\u01a1i ph\xf2ng {0} v\xe0 nh\u1eadn \u0111\u01b0\u1ee3c <color = #F7A200>{1}</color> {2} tr\u01b0\u1edbc"
          ),
          o(
            n,
            "SLOT2_NOT_PLAY",
            "Vui l\xf2ng \u0111\u1ee3i v\xf2ng quay k\u1ebft th\xfac"
          ),
          o(
            n,
          ...
          o(
            n,
            "SPLASH_GET_GET_DATA",
            "\u0110ang l\u1ea5y d\u1eef li\u1ec7u game ..."
          ),
          o(
            n,
            "SPLASH_GET_CONFIG_FAILED",
            "L\u1ea5y d\u1eef li\u1ec7u th\u1ea5t b\u1ea1i"
          ),
          o(
            n,
            "HOT_UPDATE_CHECKING_VERSION",
            "\u0110ang ki\u1ec3m tra phi\xean b\u1ea3n ..."
          ),
          o(n, "HOT_UPDATE_RETRY", "Th\u1eed l\u1ea1i ..."),
          o(
            n,
            "HOT_UPDATE_NOT_FOUND",
            "Kh\xf4ng t\xecm th\u1ea5y Hot Update ..."
          ),
          o(
            n,
            "HOT_UPDATE_DOWNLOAD_MANIFEST_FAILED",
            "T\u1ea3i manifest th\u1ea5t b\u1ea1i ..."
          ),
          o(
            n,
            "HOT_UPDATE_ALREADY_UP_TO_DATE",
            "Phi\xean b\u1ea3n m\u1edbi nh\u1ea5t ..."
          ),
          o(
            n,
            "HOT_UPDATE_FOUND_UPDATE",
            "T\xecm th\u1ea5y phi\xean b\u1ea3n c\u1eadp nh\u1eadt ..."
          ),
          ...
          o(
            n,
            "LOTTERY_SELECT_LO",
            "Ch\u1ecdn 1 s\u1ed1 b\u1ea5t k\u1ef3. B\u1ea1n s\u1ebd th\u1eafng c\u01b0\u1ee3c khi s\u1ed1 \u0111\xf3 c\xf3 trong b\u1ea3ng k\u1ebft qu\u1ea3"
          ),
          o(
            n,
            "LOTTERY_SELECT_DE",
            "Ch\u1ecdn 1 s\u1ed1 b\u1ea5t k\u1ef3. B\u1ea1n s\u1ebd th\u1eafng c\u01b0\u1ee3c khi s\u1ed1 \u0111\xf3 v\u1ec1 v\xe0o gi\u1ea3i \u0111\u1eb7c bi\u1ec7t ( gi\u1ea3i cu\u1ed1i c\xf9ng)"
          ),
          o(
            n,
            "LOTTERY_SELECT_CHAN",
            "C\u01b0\u1ee3c t\u1ea5t c\u1ea3 c\xe1c s\u1ed1 ch\u1eb5n. B\u1ea1n s\u1ebd th\u1eafng c\u01b0\u1ee3c khi k\u1ebft qu\u1ea3 v\u1ec1 c\xf3 \xedt nh\u1ea5t 14 s\u1ed1 ch\u1eb5n"
          ),
          o(
            n,
            "LOTTERY_SELECT_LE",
            "C\u01b0\u1ee3c t\u1ea5t c\u1ea3 c\xe1c s\u1ed1 l\u1ebb. B\u1ea1n s\u1ebd th\u1eafng c\u01b0\u1ee3c khi k\u1ebft qu\u1ea3 v\u1ec1 c\xf3 \xedt nh\u1ea5t 14 s\u1ed1 l\u1ebb"
          ),
          o(
            n,
            "LOTTERY_SELECT_DAU",
            "Ch\u1ecdn d\xe3y s\u1ed1 b\u1eaft \u0111\u1ea7u b\u1eb1ng s\u1ed1 b\u1ea1n ch\u1ecdn. B\u1ea1n s\u1ebd th\u1eafng c\u01b0\u1ee3c khi c\xf3 c\xe1c k\u1ebft qu\u1ea3 b\u1eaft \u0111\u1ea7u b\u1eb1ng s\u1ed1 b\u1ea1n \u0111\xe3 ch\u1ecdn"
          ),
          o(
            n,
            "LOTTERY_SELECT_DUOI",
            "Ch\u1ecdn d\xe3y s\u1ed1 k\u1ebft th\xfac b\u1eb1ng s\u1ed1 b\u1ea1n ch\u1ecdn. B\u1ea1n s\u1ebd th\u1eafng c\u01b0\u1ee3c khi c\xf3 c\xe1c k\u1ebft qu\u1ea3 k\u1ebft th\xfac b\u1eb1ng s\u1ed1 b\u1ea1n \u0111\xe3 ch\u1ecdn"
          ),
          o(
            n,
            "LOTTERY_SELECT_TRANG",
            " Ch\u1ecdn t\xe2t c\u1ea3 c\xe1c s\u1ed1 trong \xf4 tr\u1eafng. B\u1ea1n s\u1ebd th\u1eafng khi k\u1ebft qu\u1ea3 v\u1ec1 \xedt nh\u1ea5t c\xf3 14 s\u1ed1 trong \xf4 tr\u1eafng"
          ),
          o(
            n,
            "LOTTERY_SELECT_DO",
            "Ch\u1ecdn t\xe2t c\u1ea3 c\xe1c s\u1ed1 trong \xf4 \u0111\u1ecf. B\u1ea1n s\u1ebd th\u1eafng khi k\u1ebft qu\u1ea3 v\u1ec1 \xedt nh\u1ea5t c\xf3 14 s\u1ed1 trong \xf4 \u0111\u1ecf"
          ),
          o(
            n,
            "LOTTERY_SELECT_XIEN_2",
            "Ch\u1ecdn 2 s\u1ed1 b\u1ea5t k\u1ef3. B\u1ea1n s\u1ebd th\u1eafng c\u01b0\u1ee3c khi c\u1ea3 2 s\u1ed1 \u0111\xf3 c\xf3 trong b\u1ea3ng k\u1ebft qu\u1ea3"
          ),
          o(
            n,
            "LOTTERY_SELECT_XIEN_3",
            "Ch\u1ecdn 3 s\u1ed1 b\u1ea5t k\u1ef3. B\u1ea1n s\u1ebd th\u1eafng c\u01b0\u1ee3c khi c\u1ea3 3 s\u1ed1 \u0111\xf3 c\xf3 trong b\u1ea3ng k\u1ebft qu\u1ea3"
          ),
          o(
            n,
            "LOTTERY_SELECT_XIEN_4",
            "Ch\u1ecdn 4 s\u1ed1 b\u1ea5t k\u1ef3. B\u1ea1n s\u1ebd th\u1eafng c\u01b0\u1ee3c khi c\u1ea3 4 s\u1ed1 \u0111\xf3 c\xf3 trong b\u1ea3ng k\u1ebft qu\u1ea3"
          ),
          o(
            n,
            "LOTTERY_SELECT_HU",
            "Ch\u1ecdn 10 s\u1ed1 b\u1ea5t k\u1ef3. B\u1ea1n s\u1ebd th\u1eafng 50% h\u0169 khi k\u1ebft qu\u1ea3 v\u1ec1 kh\xf4ng c\xf3 10 s\u1ed1 \u0111\xe3 ch\u1ecdn (l\xf4 tr\u01b0\u1ee3t), ph\xed c\u01b0\u1ee3c 10k"
          ),
          o(
            n,
            "LOTTERY_SELECT_REBETS",
            "C\u01b0\u1ee3c l\u1ea1i to\xe0n b\u1ed9 th\xf4ng tin \u0111\u1eb7t c\u1ee7a b\u1ea1n phi\xean ch\u01a1i tr\u01b0\u1edbc"
          ),
          o(
            n,
            "LOTTERY_FIRST_BETS_NOT_SELECT",
            "Phi\xean tr\u01b0\u1edbc b\u1ea1n ch\u01b0a c\u01b0\u1ee3c g\xec"
          ),
          o(
            n,
            "LOTTERY_BETS_NOT_FORMAT",
            "S\u1ed1 l\u01b0\u1ee3ng s\u1ed1 kh\xf4ng \u0111\xfang v\u1edbi ki\u1ec3u c\u01b0\u1ee3c"
          ),
          o(
            n,
            "LOTTERY_NOT_CHANGE_BET",
            "Vui l\xf2ng \u0111\u1eb7t c\u01b0\u1ee3c song ho\u1eb7c \u0111\u1eb7t c\u01b0\u1ee3c l\u1ea1i"
          ),
          o(
            n,
            "LOTTERY_NOT_START",
            "V\xf2ng quay m\u1edbi ch\u01b0a \u0111\u01b0\u1ee3c b\u1eaft \u0111\u1ea7u"
          ),
          o(
            n,
            "LOTTERY_SELECT_TYPE",
            "Vui l\xf2ng ch\u1ecdn ki\u1ec3u c\u01b0\u1ee3c"
          ),
          ...
          o(
            n,
            "LOTTERY_CHAT",
            " <color = #FCC63C>Ch\xfac m\u1eebng t\xe0i kho\u1ea3n {0} \u0111\xe3 th\u1eafng {1} ({2})</color>"
          ),
          n)
      ...
      function (t, e, i) {
        ...
        cc.Class({
          ...
          onChangerDiem: function () {
            var t = n.numberWithCommas(
              n.getOnlyNumberInString(this.inputSoDiem.string)
            )
          ...
          onUpdateDiem: function (t) {
            ...
            ;(e = "0" === e ? "" : e),
              1 * n.getOnlyNumberInString(e) > this.diemToiDa &&
          ...
          updateTien: function () {
            ...
            this.tongTien.string = n.numberWithCommas(
              t * this.giaDiem * this.countSelect
            )
          },
          onClickHuy: function () {
            ;(this.soCuoc.string = ""),
          ...
          onClickCuoc: function () {
            if (n.isEmpty(this.soCuoc.string))
              cc.RedT.inGame.addNotice(
                "Vui l\xf2ng ch\u1ecdn s\u1ed1 mu\u1ed1n c\u01b0\u1ee3c.."
              )
            else if ("0" === this.soDiem.string)
              cc.RedT.inGame.addNotice(
                "Vui l\xf2ng nh\u1eadp \u0111i\u1ec3m c\u01b0\u1ee3c.."
              )
            else {
              var t = {}
              ;(t[this.game] = {
          ...
          onClickChon: function () {
            ...
            if (t.length > 4) {
              ...
              ;(e = e.filter(function (t) {
                return (
                  4 === t.length &&
                  4 === (t = n.getOnlyNumberInString(t)).length
                )
              })).forEach(function (t) {
                void 0 === i[t] && (i[t] = t)
              }),
        ...
        cc.Class({
          ...
          get_data: function () {
            var t =
              arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 1
            cc.RedT.send({
              g: { mini3cay: { logs: { red: this.red, page: t } } },
            })
          },
          ...
          cc.Class({
            ...
            random: function () {
              ...
              Promise.all(
                this.card.map(function (e, i) {
                  t
                    ? (e.spriteFrame = cc.RedT.util.card.random(9))
                    : 0 !== i &&
                      20 !== i &&
                      (e.spriteFrame = cc.RedT.util.card.random(9))
                })
            ...
            spin: function (t) {
              ...
              var e = cc
                  .moveTo(
                    this.RedT.speed(),
                    cc.v2(this.node.x, -(this.node.height - 104.65))
                  )
                  .easing(cc.easeInOut(3)),
                i = cc.callFunc(function () {
              ...
              if (2 === t) {
                ...
                this.node.runAction(
                  cc.sequence(cc.delayTime(0.1 * t), e, i, cc.delayTime(0.1), n)
                )
              } else
                this.node.runAction(cc.sequence(cc.delayTime(0.1 * t), e, i))
            },
                ...
                ;(c.time.string = n.getStringDateByTime(t.time)),
                  ...
                  Promise.all(
                    c.kq.map(function (e, i) {
                      e.spriteFrame = cc.RedT.util.card.getCard(
                        t.kq[i].card,
                        t.kq[i].type
                      )
                    })
        ...
        cc.Class({
          ...
          init: function (t) {
            ;(this.RedT = t),
              ...
              "true" == localStorage.getItem("mini3cay") &&
                (this.node.active = !0),
              void 0 !== cc.RedT.setting.mini3cay.position &&
                (this.node.position = cc.RedT.setting.mini3cay.position),
              void 0 !== cc.RedT.setting.mini3cay.bet &&
                cc.RedT.setting.mini3cay.bet != this.cuoc &&
                this.intChangerBet(),
              void 0 !== cc.RedT.setting.mini3cay.isSpeed &&
                this.isSpeed != cc.RedT.setting.mini3cay.isSpeed &&
                this.onClickSpeed(),
              void 0 !== cc.RedT.setting.mini3cay.isAuto &&
                this.isAuto != cc.RedT.setting.mini3cay.isAuto &&
                this.onClickAuto()
          },
          onLoad: function () {
            this.ttOffset = null
          ...
          intChangerBet: function () {
            ...
            this.bet.children.forEach(function (e) {
              e.name == cc.RedT.setting.mini3cay.bet
                ? ((t.cuoc = e.name),
                  (e.children[0].active = !0),
                  e.pauseSystemEvents())
                : ((e.children[0].active = !1), e.resumeSystemEvents())
          ...
          onClickSpeed: function () {
            ;(this.isSpeed = cc.RedT.setting.mini3cay.isSpeed = !this.isSpeed),
              ...
              (this.buttonSpeed.color = this.isSpeed
                ? cc.Color.WHITE
                : this.buttonSpeed.color.fromHEX("#A0A0A0"))
          },
          onClickAuto: function () {
            ;(this.isAuto = cc.RedT.setting.mini3cay.isAuto = !this.isAuto),
              ...
              (this.buttonAuto.color = this.isAuto
                ? cc.Color.WHITE
                : this.buttonAuto.color.fromHEX("#A0A0A0")),
              (this.buttonStop.active = !!this.isSpin && !!this.isAuto)
          },
          onClickStop: function () {
            this.onClickAuto(), (this.buttonStop.active = !1)
          ...
          onData: function (t) {
            ...
            void 0 !== t.status &&
              (1 === t.status
                ? ((this.buttonStop.active = !!this.isAuto),
                  void 0 !== t.win && t.win > 0
                    ? ((this.win = t.win),
                      (this.winC = t.code),
                      (this.winT = t.text))
                    : (this.win = 0),
                  t.card.forEach(function (t, i) {
                    e.reels[i].card[0].spriteFrame = cc.RedT.util.card.getCard(
                      t.card,
                      t.type
                    )
                  }),
          ...
          hieuUng: function () {
            if (void 0 !== this.win && this.win > 0)
              if (6 == this.winC) {
                ...
                var o = new cc.Node()
                o.addComponent(cc.Label),
                  ((o = o.getComponent(cc.Label)).string =
                    "+" + n.numberWithCommas(this.win)),
                  (o.font = cc.RedT.util.fontCong),
                  (o.lineHeight = 130),
                  (o.fontSize = 23),
          ...
          cc.Class({
            ...
            onLoad: function () {
              ...
              ;(this.node._onPreDestroy = function () {
                ...
                (this.MegaJackpot =
                  this.MegaJackpot.getComponent("MegaJackpot")),
            ...
            onDestroy: function () {
              clearInterval(this.TaiXiu.TX_Main.timeInterval),
                ...
                void 0 !== this.CaoThap.timeInterval &&
                  clearInterval(this.CaoThap.timeInterval)
            },
            playClick: function () {
              cc.RedT.audio.playClick()
            },
      ...
      function (t, e, i) {
        ...
        cc.Class({
          ...
          get_data: function () {
            ...
            ;(this.isLoad = !0),
              cc.RedT.send({
                g: { mini_poker: { log: { red: this.red, page: t } } },
              })
          },
          onData: function (t) {
            this.page.onSet(t.page, t.kmess, t.total),
            ...
            spin: function (t) {
              ...
              var e = t,
                i = cc
                  .moveTo(
                    this.RedT.speed(),
                    cc.v2(this.node.x, -(this.node.height - 138))
                  )
                  .easing(cc.easeInOut(3)),
                n = cc.callFunc(function () {
              ...
              if (4 === e) {
                ...
                this.node.runAction(cc.sequence(cc.delayTime(0.1 * e), i, n))
            },
            stop: function () {
              this.node.stopAllActions(),
                void 0 !== this.card &&
        ...
        cc.Class({
          ...
          init: function (t) {
            ;(this.RedT = t),
              ...
              "true" == localStorage.getItem("minipoker") &&
                (this.node.active = !0),
              void 0 === cc.RedT.util.fontEffect &&
                (cc.RedT.util.fontEffect = this.font),
              void 0 !== cc.RedT.setting.minipoker.position &&
                (this.node.position = cc.RedT.setting.minipoker.position),
              void 0 !== cc.RedT.setting.minipoker.bet &&
                cc.RedT.setting.minipoker.bet != this.cuoc &&
                this.intChangerBet(),
              void 0 !== cc.RedT.setting.minipoker.isSpeed &&
                this.isSpeed != cc.RedT.setting.minipoker.isSpeed &&
                this.onClickSpeed(),
              void 0 !== cc.RedT.setting.minipoker.isAuto &&
                this.isAuto != cc.RedT.setting.minipoker.isAuto &&
                this.onClickAuto()
          },
          onLoad: function () {
            var t = this
          ...
          intChangerBet: function () {
            this.bet.children.forEach(
              function (t) {
                t.name === cc.RedT.setting.minipoker.bet
                  ? ((this.cuoc = t.name),
                    (t.children[0].active = !1),
                    (t.children[1].active = !0),
                    t.pauseSystemEvents())
        ...
        cc.Class({
          ...
          onData: function (t) {
            void 0 === t.info ||
              ...
              void 0 !== t.info.menhgia &&
                this.NapThe.infoSet(t.info.menhgia, "menhgiaList", "MenhGia"),
          ...
          onSelecHinhThuc: function (t) {
            ...
            if ("momo" == e)
              (this.nodeNapThe.active = !1), (this.nodeMoMo.active = !0)
            else {
              ;(this.nodeNapThe.active = !0), (this.nodeMoMo.active = !1)
              var i = this.NapThe.scrollviewNhaMang.content.children.filter(
                function (t) {
                  var i = t
                    .getComponent("NapRed_itemOne")
    ...
    NapThe: [
      function (t, e, i) {
        ...
        cc.Class({
          ...
          onNapClick: function () {
            this.SoThe.string.length < 11 || this.SoSeri.string.length < 11
              ? cc.RedT.inGame.notice.show({
                  title: "N\u1ea0P RED",
                  text: "Th\xf4ng Tin kh\xf4ng h\u1ee3p l\u1ec7...",
                })
              : o.isEmpty(this.captcha.string)
              ? cc.RedT.inGame.notice.show({
                  title: "N\u1ea0P RED",
              ...
              (this[e] = t.map(
                function (t, c) {
                  ...
                  if ((a.init(this, e, i), n))
                    ...
                    0 == c &&
                      ((a.background.active = !0), (this.MenhGia.string = h)),
                      (a.text.string = h),
          ...
          cc.Class({
            ...
            show: function (t) {
              ;(this.node.active = !0),
                ...
                void 0 !== t.button
                  ...
                  : ((this.nodeButton.active = !1), (this.text.node.y = -14))
            },
            close: function () {
            ...
            onClickButton: function () {
              switch ((cc.RedT.audio.playClick(), this.type)) {
                ...
                case "reg_otp":
                  ;(this.node.active = !1),
                    null != cc.RedT.inGame.dialog.objShow &&
                      ((cc.RedT.inGame.dialog.profile.node.previous =
                        cc.RedT.inGame.dialog.objShow),
                      (cc.RedT.inGame.dialog.objShow.active = !1)),
                    cc.RedT.inGame.dialog.showProfile(null, "BaoMat"),
                    cc.RedT.inGame.dialog.profile.BaoMat.onSelectHead(
                      null,
                      "DangKyOTP"
                    )
              }
        ...
        cc.Class({
          ...
          onEnable: function () {
            var t = cc.RedT.inGame.player[cc.RedT.inGame.meMap],
              ...
              c = e - i
            if (((this.betMax = o - c), this.betMax < 1))
              return (
                (this.node.active = !1),
                void (cc.RedT.inGame.btm_to.active = !1)
              )
          ...
          eventMove: function (t) {
            var e =
              t.touch.getLocationY() - this.offsetY.localY + this.offsetY.y
            e < 0 ? (e = 0) : e > 287 && (e = 287),
              (this.mask.height = e),
          ...
          onOkClick: function () {
            cc.RedT.send({
              g: {
                poker: { to: n.getOnlyNumberInString(this.labelBet.string) },
              },
            })
          },
        }),
        ...
        cc.Class({
              ...
              ;(n.node.position = n.node.parent.convertToNodeSpaceAR(s)),
                ...
                n.node.runAction(
                  cc.sequence(
                    cc.delayTime(i),
                    cc.spawn(
                      cc.moveTo(0.1, this["item" + e].position),
                      cc.rotateTo(0.1, this["item" + e].angle),
                      cc.scaleTo(0.1, 1)
                    ),
                    cc.delayTime(0.1),
                    cc.scaleTo(0.1, 0, 1),
          ...
          setInfo: function (t) {
            ...
            t
              ? ((this.node.active = !0),
                ...
                void 0 !== t.bet &&
                  (this.bet.string = n.numberWithCommas(t.bet)),
                void 0 !== t.openCard &&
                  cc.RedT.inGame.player[cc.RedT.inGame.meMap] !== this &&
                  this.openCard(t.openCard),
                void 0 !== t.avatar && this.setAvatar(t.avatar))
          ...
          infoGame: function (t) {
            ...
            if (
              (void 0 !== t.nap &&
                ((t.nap = t.nap >> 0),
                t.nap > 0 &&
                  this.noticeBet(t.nap, "+", 2.5, 22, cc.RedT.inGame.font1)),
              void 0 !== t.hoa &&
                (this.miniStatus(cc.RedT.inGame.spriteHoa),
                (t.hoa = t.hoa >> 0),
                t.hoa > 0 &&
                  this.noticeBet(t.hoa, "+", 3.5, 22, cc.RedT.inGame.font1)),
              void 0 !== t.to &&
                (this.miniStatus(cc.RedT.inGame.spriteCuoc),
                (t.to = t.to >> 0),
                t.to > 0 &&
                  this.noticeBet(t.to, "+", 2.5, 22, cc.RedT.inGame.font1)),
              void 0 !== t.win &&
                this.node.runAction(
                  cc.sequence(
                    cc.delayTime(1),
              ...
              void 0 !== t.theo &&
                ...
                (t.theo = t.theo >> 0),
                t.theo > 0 &&
                  this.noticeBet(t.theo, "+", 2.5, 22, cc.RedT.inGame.font1)),
              void 0 !== t.xem &&
                (this.miniStatus(cc.RedT.inGame.spriteXem),
                (t.xem = t.xem >> 0),
                t.xem > 0 &&
                  this.noticeBet(t.xem, "+", 2.5, 22, cc.RedT.inGame.font1)),
              void 0 !== t.huy)
            ) {
              if (
                ((this.isHuy = !0),
                ...
                this.status.destroyAllChildren()
                var e = new cc.Node()
                ;((e = e.addComponent(cc.Sprite)).spriteFrame =
                  cc.RedT.inGame.spriteHuy),
            ...
            void 0 !== t.all &&
              ...
              (t.all = t.all >> 0),
              t.all > 0 &&
                this.noticeBet(t.all, "+", 2.5, 25, cc.RedT.inGame.font1))
          },
          miniStatus: function (t) {
            ...
            ;((e = e.addComponent(cc.Sprite)).spriteFrame = t),
              ...
              (e.node.scale = 3),
              (e.node.y =
                cc.RedT.inGame.player[cc.RedT.inGame.meMap] === this ? 52 : 33),
              e.node.runAction(
                cc.sequence(
                  cc.spawn(cc.fadeTo(0.1, 255), cc.scaleTo(0.1, 1)),
                  cc.delayTime(2.5),
        ...
        cc.Class({
          ...
          onLoad: function () {
            ;(cc.RedT.inGame = this),
              ...
              (this.redTcard = this.nodePanelCardMain.children.map(function (
                t
              ) {
                    ...
                    cc.callFunc(function () {
                      Object.values(this.player).forEach(function (t) {
                        ...
                        this.roomCard.children.forEach(function (e) {
                          ;(e.children[0].color =
                            e.children[0].color.fromHEX("999999")),
                            t.win.bo.forEach(function (t) {
                              e.card.card == t.card &&
                                e.card.type == t.type &&
                                (e.children[0].color =
                                  e.children[0].color.fromHEX("FFFFFF"))
                            })
                        })
                      ...
                      e.item.forEach(function (e) {
                        e.bai &&
                          t.win.bo.forEach(function (t) {
                            e.bai.card == t.card &&
                              e.bai.type == t.type &&
                              (e.node.color = e.node.color.fromHEX("FFFFFF"))
                          })
                      }),
                        2 == t.win.code
            ...
            this.game_player &&
              ...
              void 0 !== t.select
                ? ((this.botton.active = !0),
                  t.select.xem
                    ? (this.btm_xem.active = !0)
                    : (this.btm_xem.active = !1),
                  t.select.theo
                    ? (this.btm_theo.active = !0)
                    : (this.btm_theo.active = !1),
                  t.select.to
                    ? (this.btm_to.active = !0)
                    : (this.btm_to.active = !1),
                  t.select.all
                    ? (this.btm_all.active = !0)
                    : (this.btm_all.active = !1))
                : ((this.botton.active = !1), (this.nodeTo.active = !1))
          },
          mainCard: function (t) {
            var e = 0.1,
              ...
              function (t) {
                ...
                o.node.runAction(
                  cc.sequence(
                    ...
                    cc.callFunc(function () {
                      ;(o.node.position =
                        o.node.parent.convertToNodeSpaceAR(i)),
                    ...
                    cc.scaleTo(0.1, 0, 1),
                    cc.callFunc(function () {
                      ;(o.spriteFrame = cc.RedT.util.card.getCard(
                        t.card,
                        t.type
                      )),
                        (n.card = t),
          ...
          infoRoom: function (t) {
            void 0 !== t.game &&
              ...
              void 0 !== t.bet &&
                (this.mainBet.string = n.numberWithCommas(t.bet)),
              void 0 !== t.isStop &&
                ((this.labelTimeStart.node.active = !1),
                clearInterval(this.regTime1)),
              1 == t.isPlay &&
          ...
          backGame: function () {
            ;(cc.RedT.MiniPanel.node.parent = null),
              (this.dataOn = !1),
              cc.RedT.send({ g: { poker: { outgame: !0 } } }),
              (this.loading.active = !0),
              clearInterval(this.regTime1),
              cc.director.loadScene("MainGame")
          },
          ...
          togglePanel: function () {
            this.panel
              ? ((this.panel = !1), (this.nodePanelCardMain.active = !1))
              : (cc.RedT.send({ g: { poker: { maincard: !0 } } }),
          ...
          update: function () {
            if (0 != this.timeStop) {
              var t = new Date().getTime()
              ;(t -= this.timeStop) >= 8e3 &&
                ((this.timeStop = 0), this.resetGame())
            }
          },
        }),
          cc._RF.pop()
          ...
          cc.Class({
            ...
            superView: function (t) {
              "CaNhan" == t
                ...
                : "BaoMat" == t && this.onSelectHead(null, "BaoMat")
            },
            onData: function (t) {
              void 0 !== t.history && this.LichSu.onData(t.history),
                void 0 !== t.the_cao &&
                  cc.RedT.inGame.dialog.the_cao.onData(t.the_cao),
    ...
    PushNohu: [
      function (t, e, i) {
        ...
        cc.Class({
          ...
          addNotice: function (t) {
            var e
            ;((e = (e = cc.instantiate(this.prefab)).getComponent(
              "ThongBaoNoHu"
    ...
    Settings: [
      function (t, e, i) {
        ...
        cc.Class({
          ...
          setMusic: function () {
            null == localStorage.getItem("SOUND_GAME")
              ? cc.RedT.setSoundGame(!0)
              : cc.RedT.isSoundGame()
              ? (cc.RedT.IS_SOUND = !0)
              : (cc.RedT.IS_SOUND = !1)
          ...
          OnSignOutClick: function () {
            cc.RedT.inGame.notice.show({
              ...
              button: { type: "sign_out", text: "\u0110\u0102NG XU\u1ea4T" },
            })
          },
        }),
          cc._RF.pop()
      ...
      function (t, e, i) {
        ...
        cc.Class({
          ...
          onLoginClick: function () {
            ...
            this.username.string.length < 3 ||
            null === this.username.string.match(new RegExp("^[a-zA-Z0-9]+$"))
              ? cc.RedT.inGame.notice.show({
                  title: "\u0110\u0102NG NH\u1eacP",
                  text: "T\xean t\xe0i kho\u1ea3n kh\xf4ng \u0111\xfang!!",
                })
              : this.password.string.length > 32 ||
                this.password.string.length < 6
              ? cc.RedT.inGame.notice.show({
                  title: "\u0110\u0102NG NH\u1eacP",
                  text: "M\u1eadt kh\u1ea9u kh\xf4ng \u0111\xfang!!",
                })
              : !0 === this.captcha.node.active
              ? this.captcha.string.length > 6 || this.captcha.string.length < 4
                ? cc.RedT.inGame.notice.show({
                    title: "\u0110\u0102NG NH\u1eacP",
                    text: "Captcha kh\xf4ng \u0111\xfang!!",
                  })
        ...
        cc.Class({
          ...
          addEvent: function () {
            cc.systemEvent.on(
              ...
              n
                .getHTMLElementByEditBox(this.username)
          ...
          onSignNameClick: function () {
            this.username.string.length > 14 ||
            this.username.string.length < 3 ||
            null === this.username.string.match(new RegExp("^[a-zA-Z0-9]+$"))
              ? cc.RedT.inGame.notice.show({
      ...
      function (t, e, i) {
        ...
        cc.Class({
          ...
          properties: {
            ...
            repassword: { default: null, type: cc.EditBox },
            captcha: { default: null, type: cc.EditBox },
            capchaSprite: cc.Sprite,
          },
          onLoad: function () {
          ...
          onSignUpClick: function () {
            var t = null
            this.username.string.length > 32 || this.username.string.length < 3
              ? (t =
                  "\u0110\u1ed9 d\xe0i T\xean t\xe0i kho\u1ea3n 3 - 32 k\xfd t\u1ef1!!")
              : this.password.string.length > 32 ||
                this.password.string.length < 6
              ? (t =
                  "\u0110\u1ed9 d\xe0i m\u1eadt kh\u1ea9u 6 - 32 k\xfd t\u1ef1!!")
              : this.password.string !== this.repassword.string
              ? (t = "X\xe1c nh\u1eadn m\u1eadt kh\u1ea9u kh\xf4ng kh\u1edbp!")
              : this.captcha.string.length < 4
              ? (t = "Vui l\xf2ng nh\u1eadp Captcha.")
              : this.username.string == this.password.string
              ? (t =
                  "T\xe0i kho\u1ea3n kh\xf4ng \u0111\u01b0\u1ee3c tr\xf9ng v\u1edbi m\u1eadt kh\u1ea9u!!")
              : null ===
                  this.username.string.match(new RegExp("^[a-zA-Z0-9]+$")) &&
                (t = "T\xean ch\u1ec9 g\u1ed3m Ch\u1eef v\xe0 S\u1ed1!"),
              t
                ? cc.RedT.inGame.notice.show({
                    title: "\u0110\u0102NG K\xdd",
                    text: t,
          ...
          cc.Class({
            ...
            onLoad: function () {
              ;(this.isLoadScene = !1),
                ...
                cc.sys.isBrowser
                  ? this.loadAssets()
                  : (this.initHotUpdate(), this.checkUpdate())
            },
            ...
            checkPlugin: function () {
              return "undefined" == typeof sdkbox
                ? (console.log("sdkbox is undefined"), !1)
                : void 0 !== sdkbox.PluginOneSignal ||
                    (console.log("sdkbox.PluginFacebook is undefined"), !1)
            },
            loadAssets: function () {
    ...
    TaiXiuBoard: [
      function (t, e, i) {
        ...
        cc.Class({
          extends: cc.Component,
          properties: {
            textType: { default: null, type: cc.Label },
            nodeChonTien: { default: null, type: cc.Node },
            nodeChonSo: { default: null, type: cc.Node },
          },
          init: function (t) {
            this.RedT = t
          },
          ChonTienClick: function (t, e) {
            this.RedT.input.string = n.numberWithCommas(
              1 * n.getOnlyNumberInString(this.RedT.input.string) + 1 * e
            )
          },
          ChonSoClick: function (t, e) {
            this.RedT.input.string = n.numberWithCommas(
              n.getOnlyNumberInString(this.RedT.input.string + e)
            )
          },
          ...
          onCloseClick: function () {
            ;(this.node.active = !1),
              (this.RedT.input.string = this.RedT.RedT.board
                ? ""
                : "\u0110\u1eb7t c\u01b0\u1ee3c...")
          },
        }),
    ...
    TaiXiuChat: [
      function (t, e, i) {
        ...
        cc.Class({
          extends: cc.Component,
          properties: {
            content: { default: null, type: cc.ScrollView },
            item: { default: null, type: cc.Prefab },
            input: { default: null, type: cc.EditBox },
            layout: { default: null, type: cc.Layout },
            isLoad: !1,
          },
          init: function (t) {
            ;(this.RedT = t),
              void 0 !== cc.RedT.setting.taixiu.chat_active &&
          ...
          addEvent: function () {
            o.getHTMLElementByEditBox(this.input).addEventListener(
              "keydown",
              this.keyHandle,
              !1
            )
          ...
          removeEvent: function () {
            o.getHTMLElementByEditBox(this.input).removeEventListener(
              "keydown",
              this.keyHandle,
              !1
            )
          ...
          message: function (t) {
            ...
            ;(i.getComponent(cc.Label).string = t.user + ": " + t.value),
              ...
              e &&
                ...
                this.layout.node.height - this.layout.node.position.y - 134 <
                  70 &&
                setTimeout(
                  function () {
      ...
      function (t, e, i) {
        ...
        cc._RF.push(e, "47ebeX3OGJIioJo+XYY5AW7", "TaiXiuLichSuPhien_item"),
          cc.Class({
            ...
            properties: {
              time: { default: null, type: cc.Label },
              user: { default: null, type: cc.Label },
              cuoc: { default: null, type: cc.Label },
              tralai: { default: null, type: cc.Label },
            },
          }),
          cc._RF.pop()
      },
      ...
      function (t, e, i) {
        ...
        cc.Class({
          ...
          properties: {
            ...
            dice: { default: [], type: cc.Sprite },
            leftCuoc: { default: null, type: cc.Label },
            leftTraLai: { default: null, type: cc.Label },
            rightCuoc: { default: null, type: cc.Label },
            rightTraLai: { default: null, type: cc.Label },
            phien: { default: null, type: cc.Label },
            nodeTai: { default: null, type: cc.Node },
            nodeXiu: { default: null, type: cc.Node },
            scrollViewLeft: { default: null, type: cc.ScrollView },
            scrollViewRight: { default: null, type: cc.ScrollView },
            nodeNext: { default: null, type: cc.Node },
            nodePrevious: { default: null, type: cc.Node },
          },
          init: function (t) {
            this.RedT = t
          },
          ...
          getPhien: function () {
            ...
            t &&
              ((cc.RedT.inGame.loading.active = !0),
              cc.RedT.send({ taixiu: { get_phien: { phien: t } } }))
          },
          ...
          onData: function (t) {
            ...
            this.setNew(),
              ...
              (this.phien.string =
                t.phien + "  -  " + n.getStringDateByTime(t.time)),
              ...
              this.content.forEach(function (e, i) {
                ...
                if (void 0 !== o) {
                  ...
                  ;(e.phien.string = o.phien),
                    ...
                    (e.cuoc.string = n.numberWithCommas(o.bet)),
                    (e.ketqua.string =
                      o.dice1 + "-" + o.dice2 + "-" + o.dice3 + "  " + c),
                    (e.tralai.string = n.numberWithCommas(o.tralai)),
                    (e.nhan.string = n.numberWithCommas(o.betwin))
                } else e.node.active = !1
              })
          },
        }),
      ...
      function (t, e, i) {
        ...
        cc._RF.push(e, "43178FyrtFOhKXVCK9EK0Dk", "TaiXiuMain_logTips"),
          cc.Class({
            ...
            properties: {
              text: { default: null, type: cc.Label },
              tips: { default: null, type: cc.Node },
            },
            onLoad: function () {
      ...
      function (t, e, i) {
        ...
        cc.Class({
          ...
          properties: {
            ...
            diaNan: cc.Node,
            dice: { default: [], type: cc.Sprite },
            diceSF: { default: [], type: cc.SpriteFrame },
            dotLogs: cc.Node,
            diceAnimation: cc.Animation,
            efTai: a,
            efXiu: a,
            frameNan: { default: [], type: cc.SpriteFrame },
            spriteNan: cc.Sprite,
          ...
          init: function (t) {
            ;(this.RedT = t),
              ...
              (this.isNan = !1),
              void 0 === cc.RedT.util.fontCong &&
                ((cc.RedT.util.fontCong = this.fontCong),
                (cc.RedT.util.fontTru = this.fontTru)),
              void 0 === cc.RedT.setting.taixiu.getLogs &&
                (cc.RedT.setting.taixiu.getLogs = !1),
              void 0 === cc.RedT.setting.taixiu.isNan &&
                (cc.RedT.setting.taixiu.isNan = !1),
              ...
              void 0 !== cc.RedT.setting.taixiu.position &&
                (this.node.position = cc.RedT.setting.taixiu.position),
              cc.RedT.setting.taixiu.getLogs &&
                (void 0 !== cc.RedT.setting.taixiu.time_remain &&
                  (cc.RedT.setting.taixiu.time_remain++, this.nextRealTime()),
                this.reLoadGame())
          },
          onLoad: function () {
            ;(this.ttOffset = null),
              ...
              (this.onCuocClick = function () {
                ...
                if (
                  ...
                  ;(e.getComponent("mini_warning").text.string =
                    "Ti\u1ec1n c\u01b0\u1ee3c ph\u1ea3i l\u1edbn h\u01a1n 1.000 Red"),
                    this.notice.addChild(e)
                } else
                  cc.RedT.send({
                    taixiu: {
                      cuoc: { select: "left" == this.inputOld, bet: t },
                    },
                  })
              }),
              this.RedT.board &&
          ...
          addEvent: function () {
            for (var t in this.editboxs)
              c.getHTMLElementByEditBox(this.editboxs[t]).addEventListener(
                "keydown",
                this.keyHandle.bind(this),
                !1
              )
          },
          removeEvent: function () {
            for (var t in this.editboxs)
              c.getHTMLElementByEditBox(this.editboxs[t]).removeEventListener(
                "keydown",
                this.keyHandle.bind(this),
                !1
              )
          ...
          onChangerNan: function () {
            ;(cc.RedT.setting.taixiu.isNan = this.isNan = !this.isNan),
              (this.spriteNan.spriteFrame = this.isNan
                ? this.frameNan[1]
                : this.frameNan[0])
          },
          reLoadGame: function () {
            ;(this.regTimeOut2 = setTimeout(
              function () {
                this.dataLogs(),
                  cc.RedT.setting.taixiu.isNan != this.isNan &&
                    this.onChangerNan(),
          ...
          onSelectInput: function (t, e) {
            switch (
              ((this.TX_Board.node.active = !0), (this.inputOld = e), e)
            ) {
              case "right":
          ...
          onChangerInput: function () {
            var t = s.numberWithCommas(
              s.getOnlyNumberInString(this.input.string)
            )
          ...
          setDice: function () {
            ...
            this.dice.forEach(function (n, o) {
              e &&
                (n.spriteFrame =
                  i.diceSF[cc.RedT.setting.taixiu.logs[0].dice[o] - 1]),
                (n.node.active = t)
            })
          },
          onData: function (t) {
            if (
              (void 0 !== t.get_phien &&
                this.RedT.TX_LichSuPhien.onData(t.get_phien),
              void 0 !== t.err)
            ) {
              var e = cc.instantiate(this.RedT.RedT.prefabMiniNotice)
            ...
            void 0 !== t.du_day &&
              ...
              void 0 !== t.logs &&
                ...
                this.dataLogs(),
                this.setPhien(),
                cc.RedT.setting.taixiu.time_remain > 60 &&
                  (this.setDice(!0),
              ...
              void 0 !== t.finish &&
                (cc.RedT.setting.taixiu.getLogs &&
                  ...
                  cc.RedT.setting.taixiu.logs.length > 120 &&
                    cc.RedT.setting.taixiu.logs.pop(),
                  (this.diemSo =
                    t.finish.dices[0] + t.finish.dices[1] + t.finish.dices[2]),
          ...
          efStop: function () {
            this.efTai.stop(), this.efXiu.stop()
          },
          playTime: function () {
            void 0 !== this.timeInterval && clearInterval(this.timeInterval),
              (this.timeInterval = setInterval(
                function () {
                  if (cc.RedT.setting.taixiu.time_remain > 61) {
                    null !== this.bg_Dice._animator &&
                      this.bg_Dice._animator.isPlaying &&
                      this.bg_Dice.stop(),
                    ...
                    this.timePopup.node.active &&
                      ...
                      cc.RedT.setting.taixiu.time_remain < 66 &&
                    ...
                    if (
                      ...
                      var e = this.bg_Dice.getAnimationState(
                        this.bg_Dice._defaultClip.name
                      )
                    ...
                    if (
                      (null !== this.bg_Dice._animator &&
                        this.bg_Dice._animator.isPlaying &&
                        (cc.RedT.setting.taixiu.time_remain < 7
                          ? (this.bg_Dice._animator._anims.array[0].speed = 10)
                          : cc.RedT.setting.taixiu.time_remain < 23
                          ? (this.bg_Dice._animator._anims.array[0].speed = 6)
                          : cc.RedT.setting.taixiu.time_remain < 33 &&
                            (this.bg_Dice._animator._anims.array[0].speed = 3)),
                      (this.bg_efDice.active = !0),
                      this.dice[0].node.active &&
                        (this.setDice(!1, !1), this.reset()),
                      this.efStop(),
                      (this.nodeTimeWait.active =
                        this.nodeKetQua.active =
                        this.diaNan.active =
                          !1),
                      (this.timeCuoc.node.active = this.spriteNan.node.active =
                        !0),
                      cc.RedT.setting.taixiu.time_remain > 0)
                    ) {
                      t = s.numberPad(cc.RedT.setting.taixiu.time_remain - 1, 2)
                      cc.RedT.setting.taixiu.getLogs &&
                        (this.timeCuoc.string = +t),
                        this.timePopup.node.active &&
                          (this.timePopup.string = t) &&
                          (this.timePopup.node.color = cc.color(
                            155,
                            75,
                            2,
                            255
                          )),
                        cc.RedT.setting.taixiu.time_remain <= 10
                          ? (this.timeCuoc.node.color = cc.color(
                              255,
                              69,
                              69,
                              255
          ...
          onDataTaiXiu: function (t) {
            void 0 !== t.red_tai &&
              (this.totalLeft.string = s.numberWithCommas(t.red_tai)),
              void 0 !== t.red_xiu &&
                (this.totalRight.string = s.numberWithCommas(t.red_xiu)),
              void 0 !== t.red_me_tai &&
                (this.myLeft.string = s.numberWithCommas(t.red_me_tai)),
              void 0 !== t.red_me_xiu &&
                (this.myRight.string = s.numberWithCommas(t.red_me_xiu)),
              void 0 !== t.red_player_tai &&
                (this.playerLeft.string = s.numberWithCommas(t.red_player_tai)),
              void 0 !== t.red_player_xiu &&
                (this.playerRight.string = s.numberWithCommas(t.red_player_xiu))
          },
          onDuDay: function (t) {
          ...
          dataLogs: function () {
            if (cc.RedT.setting.taixiu.logs.length) {
              ...
              for (var u = 0; u < d.length; u++) {
                if (void 0 !== d[u]) {
                  ...
                  var l = d[u].dice[0],
                    ...
                    g = d[u].dice[2],
                    m = l + p + g
                  ;(e[u] = { x: 28 * u, y: 28 * l - 28, dice: l }),
                    (i[u] = { x: 28 * u, y: 28 * p - 28, dice: p }),
                    (n[u] = { x: 28 * u, y: 28 * g - 28, dice: g }),
                    (o[u] = { x: 27.7 * u, y: 9.233 * m - 27.7, tong: m })
                } else t.RedT.TX_ThongKe.lineAc(u, !1)
              }
              t.RedT.TX_ThongKe.draw(
                t.RedT.TX_ThongKe.dice1_line,
                t.RedT.TX_ThongKe.dice1_dots,
                e
              ),
                t.RedT.TX_ThongKe.draw(
                  t.RedT.TX_ThongKe.dice2_line,
                  t.RedT.TX_ThongKe.dice2_dots,
                  i
                ),
                t.RedT.TX_ThongKe.draw(
                  t.RedT.TX_ThongKe.dice3_line,
                  t.RedT.TX_ThongKe.dice3_dots,
                  n
                ),
              ...
              Promise.all([f, T]).then(function (e) {
                var i = e[1]
                i.reverse(),
                  (i = i.slice(0, 20)).reverse(),
                  (t.RedT.TX_ThongKe.KetQuaLeft.string = e[0].filter(function (
                    t
                  ) {
                    return 1 == t
                  }).length),
                  (t.RedT.TX_ThongKe.KetQuaRight.string = e[0].filter(function (
                    t
                  ) {
                    return 0 == t
                  }).length),
          ...
          reset: function () {
            this.setPhien(),
              ...
              (cc.RedT.setting.taixiu.data.taixiu.red_me_tai =
                cc.RedT.setting.taixiu.data.taixiu.red_me_xiu =
                cc.RedT.setting.taixiu.data.taixiu.red_player_tai =
                cc.RedT.setting.taixiu.data.taixiu.red_player_xiu =
                cc.RedT.setting.taixiu.data.taixiu.red_tai =
                cc.RedT.setting.taixiu.data.taixiu.red_xiu =
                this.totalLeft.string =
                this.totalRight.string =
                this.myLeft.string =
                this.myRight.string =
                this.playerLeft.string =
                this.playerRight.string =
                  0)
          },
          setDefautl: function () {
              ...
              function () {
                if (!this.isNan) {
                  ...
                  if (
                    (e.addComponent(cc.Label),
                    ((e = e.getComponent(cc.Label)).string =
                      (t.win ? "+" : "-") + s.numberWithCommas(t.bet)),
                    ...
                    i.addComponent(cc.Label),
                      ((i = i.getComponent(cc.Label)).string =
                        (t.win ? "+" : "-") + s.numberWithCommas(t.thuong)),
                      (i.font = cc.RedT.util.fontEffect),
                      (i.lineHeight = 90),
                      (i.fontSize = 14),
                      this.notice.addChild(i.node),
      ...
      function (t, e, i) {
        ...
        cc._RF.push(e, "44a1auDXjdMUYNeCt2i6vXW", "TaiXiuThongKe"),
          cc.Class({
            ...
            init: function (t) {
              ;(this.RedT = t),
                void 0 !== cc.RedT.setting.taixiu.tk_position &&
                  (this.node.position = cc.RedT.setting.taixiu.tk_position),
                void 0 !== cc.RedT.setting.taixiu.tk_active &&
                ...
                (this.DiemSoCel = this.DiemSoCel.children.map(function (t) {
                  return (
                    (t.RedT = t.children.map(function (t) {
                      return (
                        ((t = t.getComponent(cc.Sprite)).text =
                          t.node.children[0].getComponent(cc.Label)),
                        t
                      )
                    })),
                    t
            ...
            draw_Tong: function (t, e) {
              ...
              for (var i = 0, n = e.length; i < n; i++) {
                ...
                0 === i ? t.moveTo(o.x, o.y) : t.lineTo(o.x, o.y),
                  ...
                  (c.text.node.color = this.RedT.TX_Main.taixiu
                    ? o.tong > 10
                      ? cc.Color.WHITE
                      : cc.Color.BLACK
                    : o.tong % 2
                  ...
                  (c.node.color = this.RedT.TX_Main.taixiu
                    ? o.tong > 10
                      ? cc.color().fromHEX("#B3A1A1")
                      : cc.Color.WHITE
                    : o.tong % 2
                  ...
                  (c.spriteFrame =
                    o.tong > 10
                      ? this.RedT.TX_Main.dot_black
                      : this.RedT.TX_Main.dot_white)
              }
              t.stroke()
            },
            lineAc: function (t, e) {
            ...
            this.content.forEach(
              function (e, i) {
                ...
                void 0 !== o
                  ? ((e.node.active = !0),
                    i > 2
                      ? ((e.top.node.active = !0), (e.top.string = i + 1))
                      : (e.top.node.active = !1),
        ...
        cc._RF.push(e, "1dcc4TRp5REZa8M+IY8ljzM", "TaiXiu_efScale"),
          cc.Class({
            ...
            play: function () {
              this.node.runAction(
                cc.repeatForever(
                  cc.sequence(cc.scaleTo(0.15, 0.85), cc.scaleTo(0.15, 1.15))
                )
              )
            },
            stop: function () {
    ...
    TaiXiu_topItem: [
      function (t, e, i) {
        ...
        cc._RF.push(e, "9f880MppyFGFavfg+L9Oz+9", "TaiXiu_topItem"),
          cc.Class({
            extends: cc.Component,
            properties: { top: cc.Label, nick: cc.Label, win: cc.Label },
          }),
          cc._RF.pop()
      },
      {},
        ...
        cc.Class({
          ...
          init: function (t) {
            ;(this.RedT = t),
              ...
              "true" == localStorage.getItem("taixiu") &&
                (this.node.active = !0)
          },
          onEnable: function () {
            this.regEvent(!0)
          ...
          closeGame: function () {
            cc.RedT.audio.playUnClick(),
              (this.node.active =
                this.TX_ThongKe.node.active =
                this.TX_Main.TX_Board.node.active =
                  !1),
              localStorage.setItem("taixiu", !1)
          },
          newGame: function () {
            ;(this.TX_ThongKe.node.active = this.TX_Main.TX_Board.node.active =
              !1),
    ...
    TheCao: [
      function (t, e, i) {
        ...
        cc.Class({
          ...
          getData: function (t) {
            ;(cc.RedT.inGame.loading.active = !0),
              cc.RedT.send({ user: { history: { the_cao: t } } })
          },
          setData: function (t) {
      ...
      function (t, e, i) {
        ...
        cc.Class({
          ...
          onClickBox: function (t, e) {
            this.numberBonus.string &&
              (cc.RedT.audio.playClick(), this.onSend(e))
          },
          closeNotice: function () {
            ;(this.notice.active = this.node.active = !1), this.RedT.hieuUng()
          },
          onData: function (t) {
            if (void 0 !== t.box) {
              ...
              ;(e.children[0].active = !1),
                ...
                (e.children[2].getComponent(cc.Label).string =
                  n.numberWithCommas(t.bet)),
                (this.numberBonus.string = t.bonus)
            }
            void 0 !== t.win &&
              ((this.notice.active = !0),
        ...
        cc._RF.push(e, "d81dcoZgsNLupexKbEe58JH", "VuongQuocRed_reel"),
          cc.Class({
            ...
            spin: function (t) {
              this.node.stopAllActions()
              var e = cc
                  .moveTo(1, cc.v2(this.node.x, -(this.node.height - 472)))
                  .easing(cc.easeInOut(3)),
                i = cc.callFunc(function () {
                  0 === t && this.RedT.copy(), (this.node.y = 0)
                }, this)
      ...
      function (t, e, i) {
        ...
        cc.Class({
          ...
          properties: {
            gameBonus: s,
            audioClick: cc.AudioSource,
            redhat: { default: null, type: cc.Node },
            reels: { default: [], type: o },
            icons: { default: [], type: cc.SpriteFrame },
            betString: { default: [], type: cc.String },
            iconPrefab: { default: null, type: cc.Prefab },
            BigWin: cc.Animation,
            BigWin_Label: cc.Label,
            NoHu: cc.Animation,
            NoHu_Label: cc.Label,
            ...
            buttonStop: cc.Node,
            nodeChangerBet: cc.Node,
            bet: { default: null, type: cc.Label },
            nodeNotice: cc.Node,
            prefabNotice: { default: null, type: cc.Prefab },
              ...
              this.content.forEach(function (i, o) {
                ...
                void 0 !== c
                  ? ((i.node.active = !0),
                    ...
                    (i.status.string = c.thanhtoan
                      ? "\u0110\xe3 S\u1ed5"
                      : "Ch\u1edd S\u1ed5"),
                    (i.status.node.color = c.thanhtoan
                      ? cc.color(0, 255, 0, 255)
                      : cc.color(255, 214, 0, 255)))
                  : (i.node.active = !1)
              })
          },
          getLoai: function (t) {
        ...
        cc.Class({
          ...
          update: function () {
            ...
            this.today.string =
              this.day(t.getDay()) +
              " " +
              n.addZero10(t.getDate()) +
              "/" +
              n.addZero10(t.getMonth() + 1) +
              "/" +
              t.getFullYear() +
              " " +
              n.addZero10(t.getHours()) +
              ":" +
              n.addZero10(t.getMinutes()) +
              ":" +
              n.addZero10(t.getSeconds())
          },
          day: function (t) {
            var e = new Array(7)
            return (
                ...
                this.content.map(function (i, o) {
                  ...
                  if (void 0 !== c) {
                    ...
                    c.kq.forEach(function (t) {
                      ...
                      (i.kqSprite.spriteFrame =
                        0 === s ? e.iconRed : s % 2 ? e.iconRed : e.iconWhite),
                      ...
                      (i.white4.node.color =
                        0 === s ? cc.Color.YELLOW : cc.Color.WHITE),
                      (i.white3.node.color =
                        1 === s ? cc.Color.YELLOW : cc.Color.WHITE),
                      (i.red3.node.color =
                        3 === s ? cc.Color.YELLOW : cc.Color.WHITE),
                      (i.red4.node.color =
                        4 === s ? cc.Color.YELLOW : cc.Color.WHITE)
        ...
        cc.Class({
          ...
          ctor: function () {
            ;(this.logs = []),
              ...
              (this.clients = {
                red: { chan: 0, le: 0, red3: 0, red4: 0, white3: 0, white4: 0 },
              }),
              (this.users = {
                red: { chan: 0, le: 0, red3: 0, red4: 0, white3: 0, white4: 0 },
              })
          ...
          backGame: function () {
            ;(cc.RedT.MiniPanel.node.parent = null),
              clearInterval(this.timeInterval),
              cc.RedT.send({ g: { xocxoc: { outgame: !0 } } }),
              (this.loading.active = !0),
          ...
          ingameChip: function (t) {
            ...
            try {
              for (
                var c, s = Object.entries(t)[Symbol.iterator]();
                !(e = (c = s.next()).done);
                e = !0
              ) {
                var a = c.value,
                ...
                try {
                  for (
                    var m, f = Object.entries(d)[Symbol.iterator]();
                    !(l = (m = f.next()).done);
                    l = !0
                  ) {
                    var T = m.value,
                    ...
                    if (_ > 0)
                      for (; _; ) {
                        var C = (Math.random() * (u.x + 1)) >> 0,
                          ...
                          R = new cc.Node()
                        ;((R = R.addComponent(cc.Sprite)).spriteFrame =
                          this["chip_" + b]),
          ...
          showKQ2: function () {
            ...
            var c = this.box_chip.parent.convertToWorldSpaceAR(
                this.box_chip.position
              ),
              s = null
            o % 2
              ...
              case 0:
                ;(n = this.box_white4.children[1]),
                  ...
                  this.box_red3.children[1].children.forEach(function (t) {
                    t.runAction(
                      cc.spawn(cc.scaleTo(0.4, 0.5), cc.moveTo(0.4, a))
                    )
                  }),
                  this.box_red4.children[1].children.forEach(function (t) {
                    t.runAction(
                      cc.spawn(cc.scaleTo(0.4, 0.5), cc.moveTo(0.4, h))
                    )
                  }),
                  this.box_white3.children[1].children.forEach(function (t) {
                    t.runAction(
                      cc.spawn(cc.scaleTo(0.4, 0.5), cc.moveTo(0.4, r))
                    )
                  })
                break
              case 1:
                ;(n = this.box_white3.children[1]),
                  ...
                  this.box_white4.children[1].children.forEach(function (t) {
                    t.runAction(
                      cc.spawn(cc.scaleTo(0.4, 0.5), cc.moveTo(0.4, d))
                    )
                  })
                break
              case 2:
                ...
                function () {
                        ...
                        i.addChild(e),
                          e.runAction(
                            cc.sequence(
                              cc.spawn(
                                cc.scaleTo(0.4, 0.3),
                                cc.moveTo(0.4, cc.v2(n, o))
                              ),
                              cc.sequence(
                                cc.moveTo(0.1, cc.v2(n, o - 6)),
                                cc.moveTo(0.1, cc.v2(n, o))
                              )
                            )
                          )
                      }.bind(this)
                        ...
                        n.addChild(i),
                          i.runAction(
                            cc.sequence(
                              cc.spawn(
                                cc.scaleTo(0.4, 0.3),
                                cc.moveTo(0.4, cc.v2(o, c))
                              ),
                              cc.sequence(
                                cc.moveTo(0.1, cc.v2(o, c - 6)),
                                cc.moveTo(0.1, cc.v2(o, c))
                              )
                            )
                          )
                      }.bind(this)
                  ...
                  e &&
                    [1, 2, 3, 4, 5].forEach(
                      function (t) {
                        1 !== t
                          ? this["audioMultiChip" + t].play()
                          : this.audioMultiChip.play()
                      }.bind(this)
                    ),
                    (this.regTimeOut2 = setTimeout(
                      function () {
                        var t = this.users_bg.parent.convertToWorldSpaceAR(
                            this.users_bg.position
                          ),
                          e = i.convertToNodeSpaceAR(t)
                        if (
                          (i.children.forEach(function (t) {
                            t.runAction(
                              cc.spawn(cc.fadeTo(0.4, 0), cc.moveTo(0.4, e))
                            )
                          }),
                          n)
                        ) {
                          ...
                          n.children.forEach(function (t) {
                            t.runAction(
                              cc.spawn(cc.fadeTo(0.4, 0), cc.moveTo(0.4, o))
                            )
                          })
                        }
                      }.bind(this),
          ...
          setDot: function (t) {
            ...
            n > 22 && (i -= i / 1.4),
              ...
              (n = (i = (Math.random() * (this.maxDot.y + 1)) >> 0) - e) > 22 &&
                (i -= i / 1.4),
                ...
                function () {
                  if (this.time_remain > 32) {
                    ...
                    (this.labelTime.node.active = !1),
                      ...
                      32 === this.time_remain &&
                        this.nodeBat.runAction(this.actionBatClose)
          ...
          updateData: function (t) {
            ;(this.total_chan.string =
              t.red.chan > 0 ? o.numberWithCommas(t.red.chan) : ""),
              (this.total_le.string =
                t.red.le > 0 ? o.numberWithCommas(t.red.le) : ""),
              (this.total_red3.string =
                t.red.red3 > 0 ? o.numberWithCommas(t.red.red3) : ""),
              (this.total_red4.string =
                t.red.red4 > 0 ? o.numberWithCommas(t.red.red4) : ""),
              (this.total_white3.string =
                t.red.white3 > 0 ? o.numberWithCommas(t.red.white3) : ""),
              (this.total_white4.string =
                t.red.white4 > 0 ? o.numberWithCommas(t.red.white4) : "")
          },
          resetData: function () {
          ...
          onCuoc: function (t, e) {
            cc.RedT.send({
              g: { xocxoc: { cuoc: { cuoc: this.cuoc, box: e } } },
            })
          },
          addNotice: function (t) {
            var e = cc.instantiate(this.prefabNotice)
          ...
          clientsChip: function (t) {
            ...
            var n = this.users_bg.parent.convertToWorldSpaceAR(
              this.users_bg.position
            )
            n = e.children[1].convertToNodeSpaceAR(n)
            var o = new cc.Node()
            ;((o = o.addComponent(cc.Sprite)).spriteFrame =
              this["chip_" + t.cuoc]),
              (o.node.position = n),
              (o.node.scale = 0.67)
            ...
            o.node.addChild(a),
              ...
              o.node.runAction(
                cc.sequence(
                  ...
                  cc.sequence(
                    cc.moveTo(0.1, cc.v2(c, s - 6)),
                    cc.moveTo(0.1, cc.v2(c, s))
                  )
                )
              )
          },
          meChip: function (t) {
            ...
            var c = new cc.Node()
            ;((c = c.addComponent(cc.Sprite)).spriteFrame =
              this["chip_" + t.cuoc]),
              (c.node.position = o)
            ...
            c.node.addChild(h),
              ...
              c.node.runAction(
                cc.sequence(
                  ...
                  cc.sequence(
                    cc.moveTo(0.1, cc.v2(s, a + 6)),
                    cc.moveTo(0.1, cc.v2(s, a))
                  )
                )
              )
          },
          ...
          updateMeCoint: function () {
            ;(this.me_chan.string =
              this.users.red.chan > 0
                ? o.numberWithCommas(this.users.red.chan)
                : ""),
              (this.me_le.string =
                this.users.red.le > 0
                  ? o.numberWithCommas(this.users.red.le)
                  : ""),
              (this.me_red3.string =
                this.users.red.red3 > 0
                  ? o.numberWithCommas(this.users.red.red3)
                  : ""),
              (this.me_red4.string =
                this.users.red.red4 > 0
                  ? o.numberWithCommas(this.users.red.red4)
                  : ""),
              (this.me_white3.string =
                this.users.red.white3 > 0
                  ? o.numberWithCommas(this.users.red.white3)
                  : ""),
              (this.me_white4.string =
                this.users.red.white4 > 0
                  ? o.numberWithCommas(this.users.red.white4)
                  : ""),
              (this.total_chan.string =
                this.clients.red.chan > 0
                  ? o.numberWithCommas(this.clients.red.chan)
                  : ""),
              (this.total_le.string =
                this.clients.red.le > 0
                  ? o.numberWithCommas(this.clients.red.le)
                  : ""),
              (this.total_red3.string =
                this.clients.red.red3 > 0
                  ? o.numberWithCommas(this.clients.red.red3)
                  : ""),
              (this.total_red4.string =
                this.clients.red.red4 > 0
                  ? o.numberWithCommas(this.clients.red.red4)
                  : ""),
              (this.total_white3.string =
                this.clients.red.white3 > 0
                  ? o.numberWithCommas(this.clients.red.white3)
                  : ""),
              (this.total_white4.string =
                this.clients.red.white4 > 0
                  ? o.numberWithCommas(this.clients.red.white4)
                  : "")
          },
          status: function (t) {
            this.regTimeOut3 = setTimeout(
              function () {
                ...
                if (
                  (e.addComponent(cc.Label),
                  ((e = e.getComponent(cc.Label)).string =
                    (t.win ? "+" : "-") + o.numberWithCommas(t.bet)),
                  (e.font = t.win
                    ? cc.RedT.util.fontCong
                    : cc.RedT.util.fontTru),
                  (e.lineHeight = 130),
        ...
        cc._RF.push(e, "3ae4e1beQZEMZqnzzUxgnG9", "Zeus_reel"),
          cc.Class({
            ...
            spin: function (t, e) {
              this.node.stopAllActions()
              var i = cc
                  .moveTo(e, cc.v2(this.node.x, -(this.node.height - 396)))
                  .easing(cc.easeInOut(3)),
                n = cc.callFunc(function () {
                  0 === t && this.RedT.copy(), (this.node.y = 0)
                }, this)
              if (4 === t) {
                ...
                this.node.runAction(cc.sequence(cc.delayTime(0.1 * t), i, n))
            },
            stop: function () {
              this.node.stopAllActions(), this.RedT.copy(), (this.node.y = 0)
            },
            ...
            if (void 0 !== cc.RedT.setting.topHu.data) {
              ...
              Promise.all(
                ...
                s - i[0].bet != 0 &&
                  n.numberTo(
                    t.hu100,
                    n.getOnlyNumberInString(t.hu100.string),
                    i[0].bet,
                    4900,
                    !0
                  ),
                  a - o[0].bet != 0 &&
                    n.numberTo(
                      t.hu1000,
                      n.getOnlyNumberInString(t.hu1000.string),
                      o[0].bet,
                      4900,
                      !0
                    ),
                  h - c[0].bet != 0 &&
                    n.numberTo(
                      t.hu10000,
                      n.getOnlyNumberInString(t.hu10000.string),
                      c[0].bet,
                      4900,
                      !0
                    )
        ...
        cc.Class({
          ...
          onClickTiep: function () {
            ...
            t < 5e4
              ...
              ? cc.RedT.inGame.notice.show({
                  title: "L\u1ed6I",
                  text: "Vui l\xf2ng ch\u1ecdn th\u1ebb ATM thu\u1ed9c Ng\xe2n H\xe0ng b\u1ea1n mu\u1ed1n n\u1ea1p.",
                })
              : this.editOTP.string.length < 4
              ? cc.RedT.inGame.notice.show({
                  title: "L\u1ed6I",
                  text: "M\xe3 OTP kh\xf4ng h\u1ee3p l\u1ec7.",
                })
      ...
      function (t, e, i) {
        ...
        cc.Class({
          ...
          properties: {
            ...
            moreBank: cc.Node,
            scrollviewBank: { default: null, type: cc.ScrollView },
            prefab: cc.Prefab,
            isLoad: !1,
          ...
          clean: function () {
            this.inputTien.string =
              ...
              this.inputSTK.string =
              this.inputKhop.string =
              this.inputNameGo.string =
                ""
          },
          toggleMoreBank: function () {
            this.moreBank.active = !this.moreBank.active
            ...
            switch (
              ...
              t.target.parent.children.forEach(
                function (t) {
                  t.name === e
                    ? ((t.children[0].active = !0),
                      (this.labelHinhthuc.string = t.children[1].getComponent(
                        cc.Label
                      ).string))
                    : (t.children[0].active = !1),
          ...
          onClickNap: function () {
            if (this.labelNumber.string.length)
              if ("1" === this.hinhThuc && this.inputKhop.string.length < 6)
                ...
                "3" === this.hinhThuc &&
                this.inputNameGo.string.length < 6
              )
                cc.RedT.inGame.notice.show({
                  title: "N\u1ea0P RED",
                ...
                o.getOnlyNumberInString(this.inputTien.string) >> 0 <
                2e5
              )
                cc.RedT.inGame.notice.show({
                  title: "N\u1ea0P RED",
    ...
    bankRut: [
      function (t, e, i) {
        ...
        cc.Class({
          ...
          onClick: function () {
            var t = null
            o.isEmpty(this.editBank.string) ||
            o.isEmpty(this.editNumber.string) ||
            o.isEmpty(this.editName.string) ||
            o.isEmpty(this.editRut.string) ||
            o.isEmpty(this.editOTP.string)
              ? (t = "Ki\u1ec3m tra l\u1ea1i c\xe1c th\xf4ng tin...")
              : o.getOnlyNumberInString(this.editRut.string) < 1e4 &&
                (t =
                  "S\u1ed1 ti\u1ec1n R\xdaT t\u1ed1i thi\u1ec3u l\xe0 100.000."),
              t
                ? cc.RedT.inGame.notice.show({ title: "L\u1ed6I", text: t })
                : cc.RedT.send({
                    shop: {
                      bank: {
                        rut: {
          ...
          cc.Class({
            ...
            select: function (t) {
              ...
              this.game.forEach(function (e) {
                var i = e.node.parent
                i.name == t
                  ? ((i.children[0].active = !0), i.pauseSystemEvents())
                  : ((i.children[0].active = !1), i.resumeSystemEvents())
              }),
                this.content.children.forEach(function (e) {
        ...
        cc.Class({
                  ...
                  ;((i = i.getComponent("EVipPoint_item")).bg.active = e % 2),
                    ...
                    0 === e
                      ? ((i.icon1.active = !0),
                        ...
                        (i.top.node.active = !1),
                        (i.nick.node.color =
                          i.nick.node.color.fromHEX("#FF06E1")),
          ...
          onHeadSelect: function (t) {
            ...
            this.head.children.forEach(function (t) {
              t.name === e
                ? ((t.children[0].active = !1), (t.children[1].active = !0))
                : ((t.children[0].active = !0), (t.children[1].active = !1))
            }),
              this.body.children.forEach(function (t) {
                t.name === e ? (t.active = !0) : (t.active = !1)
          ...
          cc.Class({
            ...
            init: function (t, e, i) {
              this.coint.on(
                ...
                (this.node.x =
                  e.x + Math.floor(Math.random() * (2 * i.x + 1)) - i.x),
                (this.node.y =
                  e.y + Math.floor(Math.random() * (2 * i.y + 1)) - i.y),
                t.RedT.Game.nodeCoint.addChild(this.node),
                (i = null)
              var n = t.iconCoint.node.parent.convertToWorldSpaceAR(
                t.iconCoint.node.position
              )
          ...
          cc.Class({
            ...
            onLoad: function () {
              ;(this.initScale = this.node.scale),
                (this.scaleOnAction = cc.scaleTo(
                  this.transDuration,
                  this.pressedScale
                )),
                (this.scaleOffAction = cc.scaleTo(
                  this.transDuration,
                  this.initScale
                ))
            },
    ...
    iMessage: [
      function (t, e, i) {
        ...
        cc.Class({
          ...
          onData: function (t) {
            t.list && (this.list(t.list), this.countNews(t.list)),
              t.text && (this.text.string = t.text),
              t.news &&
                (t.news > 0
                  ? ((this.news.node.active = !0), (this.news.string = t.news))
          ...
          onContentClick: function (t) {
            ...
            t.message != this.message &&
              ...
              Promise.all(
                ...
                ;(t = t.length) > 0
                  ? ((e.news.node.active = !0), (e.news.string = t))
                  : (e.news.node.active = !1)
              }))
          },
          ...
          countNews: function (t) {
            ...
            ;(e = e.length) > 0
              ? ((this.news.node.active = !0), (this.news.string = e))
              : (this.news.node.active = !1)
          },
        }),
          cc._RF.pop()
    ...
    iconGameHu: [
      function (t, e, i) {
        ...
        cc._RF.push(e, "b464brTuF9Jkai40xgtDiaq", "iconGameHu"),
          cc.Class({
            extends: cc.Component,
            properties: { hu100: cc.Label, hu1k: cc.Label, hu10k: cc.Label },
          }),
          cc._RF.pop()
      },
      {},
    ...
    iconGameTaiXiu: [
      function (t, e, i) {
        ...
        cc._RF.push(e, "f5d22VsrEZLuKko/Zky02F3", "iconGameTaiXiu"),
          cc.Class({
            extends: cc.Component,
            properties: { tai: cc.Label, xiu: cc.Label },
          }),
          cc._RF.pop()
      },
      {},
    ...
    iconGame: [
      function (t, e, i) {
        ...
        cc._RF.push(e, "a98fahA/phPCZvYv2bUDP1B", "iconGame"),
          cc.Class({
            extends: cc.Component,
            properties: { slot: !1, mini: !1, bai: !1, khac: !1 },
          }),
          cc._RF.pop()
      },
      {},
      ...
      function (t, e, i) {
        ...
        cc.Class({
          ...
          properties: {
            ...
            gdb: cc.Label,
            g1: cc.Label,
            g2: { default: [], type: cc.Label },
            g3: { default: [], type: cc.Label },
            g4: { default: [], type: cc.Label },
            g5: { default: [], type: cc.Label },
            g6: { default: [], type: cc.Label },
            g7: { default: [], type: cc.Label },
            tk0: cc.Label,
            tk1: cc.Label,
            tk2: cc.Label,
            tk3: cc.Label,
          ...
          onData: function (t) {
            ...
            var e = [
                t.g1.substring(t.g1.length - 2),
                t.gdb.substring(t.gdb.length - 2),
              ].concat(
                t.g2.map(function (t) {
            ...
            i.length > 0 && (this.tk0.string = i.join(", ")),
              ...
              d.length > 0 && (this.tk8.string = d.join(", ")),
          ...
          cc.Class({
            ...
            onLoad: function () {
              ;(cc.RedT.setting.popupEvent = cc.RedT.setting.popupEvent || {}),
                (this.ttOffset = null),
                (this.ttOffset2 = null),
                void 0 !== cc.RedT.setting.popupEvent.position &&
            ...
            eventMove: function (t) {
              var e = t.touch.getLocationX() - this.ttOffset.x,
                i = t.touch.getLocationY() - this.ttOffset.y
              Math.abs(e) > cc.RedT.inGame.node.width / 2 - 100 &&
                (e =
                  e < 0
                    ? -cc.RedT.inGame.node.width / 2 + 100
                    : cc.RedT.inGame.node.width / 2 - 100),
                Math.abs(i) > cc.RedT.inGame.node.height / 2 - 50 &&
                  (i =
                    i < 0
                      ? -cc.RedT.inGame.node.height / 2 + 50
                      : cc.RedT.inGame.node.height / 2 - 50),
                (this.node.position = cc.v2(e, i))
            },
            eventEnd: function (t) {
        ...
        cc._RF.push(e, "acd26OFlQpFU6xTJ63KhBKq", "popupMinigame"),
          cc.Class({
            ...
            properties: {
              ...
              time: { default: null, type: cc.Label },
              nodeTime: { default: null, type: cc.Node },
            ...
            onLoad: function () {
              ;(cc.RedT.setting.popupMini = cc.RedT.setting.popupMini || {}),
                ...
                (this.ttOffset2 = null),
                (this.toggleRuning = !1),
                void 0 !== cc.RedT.setting.popupMini.position &&
                  (this.node.position = cc.RedT.setting.popupMini.position),
                void 0 !== cc.RedT.setting.popupMini.open &&
                  (cc.RedT.setting.popupMini.open
                    ? ((this.list.active = !0),
            ...
            eventMove: function (t) {
              var e = t.touch.getLocationX() - this.ttOffset.x,
                i = t.touch.getLocationY() - this.ttOffset.y
              Math.abs(e) > cc.RedT.inGame.node.width / 2 - 50 &&
                (e =
                  e < 0
                    ? -cc.RedT.inGame.node.width / 2 + 50
                    : cc.RedT.inGame.node.width / 2 - 50),
                Math.abs(i) > cc.RedT.inGame.node.height / 2 - 50 &&
                  (i =
                    i < 0
                ...
                this.toggleRuning ||
                  ...
                  this.list.active
                    ? ((cc.RedT.setting.popupMini.open = !1),
                      this.nodeTime.active
                        ? this.nodeTime.runAction(cc.moveTo(0.3, cc.v2(25, 43)))
                        : (this.nodeTime.position = cc.v2(25, 43)),
                      this.list.runAction(
                        cc.sequence(
                          cc.spawn(
                            cc.scaleTo(0.3, 0.2).easing(cc.easeBackIn(3)),
                            cc.rotateTo(0.3, -720)
                          ),
                          cc.callFunc(function () {
                    ...
                    : ((this.list.active = cc.RedT.setting.popupMini.open = !0),
                      this.nodeTime.active
                        ? this.nodeTime.runAction(
                            cc.moveTo(0.3, cc.v2(-155.7, 43))
                          )
                        : (this.nodeTime.position = cc.v2(-155.7, 43)),
                      this.list.runAction(
                        cc.sequence(
        ...
        cc.Class({
          ...
          onLoad: function () {
            ;(this.ttOffset = null),
              ...
              void 0 !== cc.RedT.setting.topHu.position &&
                (this.node.position = cc.RedT.setting.topHu.position),
              void 0 !== cc.RedT.setting.topHu.open &&
                (this.body.active = cc.RedT.setting.topHu.open),
              void 0 !== cc.RedT.setting.topHu.data &&
          ...
          eventEnd: function (t) {
            ;(cc.RedT.setting.topHu.position = this.node.position),
              (this.xChanger =
                this.ttOffset2.x - (t.touch.getLocationX() - this.ttOffset.x)),
              (this.yChanger =
                this.ttOffset2.y - (t.touch.getLocationY() - this.ttOffset.y)),
              this.xChanger < 5 &&
                this.xChanger > -5 &&
                this.yChanger < 5 &&
                this.yChanger > -5 &&
          ...
          onChangerBet: function (t, e) {
            ;(this.bet = e),
              this.header.forEach(function (e) {
                t.target !== e.node.parent
                  ? (e.font = cc.RedT.MiniPanel.TaiXiu.TX_Main.fontTru)
                  : (e.font = cc.RedT.MiniPanel.TaiXiu.TX_Main.fontCong)
              }),
              this.onChangerData()
          },
          onData: function (t) {
            ...
            if (void 0 !== cc.RedT.setting.topHu.data) {
              var t = [],
                e = this.content.children.map(
                  function (e) {
                    ...
                    return (
                      (t[i] = e),
                      n.length ? (n[0].name = i) : (n[0] = { name: i, bet: 0 }),
                      n[0]
                    )
                  }.bind(this)
                )
              ;(e = e.sort(function (t, e) {
                ...
                function (e, i) {
                  ...
                  o.stopAllActions()
                  var c = -(75 * (i + 1) - 37.5)
                  o.runAction(cc.moveTo(0.2, cc.v2(0, c))),
                    n.getOnlyNumberInString(o.hu.string) - e.bet != 0 &&
                      n.numberTo(
                        o.hu,
                        n.getOnlyNumberInString(o.hu.string),
                        e.bet,
                        2e3,
                        !0
                      ),
                    e.balans > 0 && this.x[e.x - 2]
                      ? ((o.xHu.node.active = !0),
        ...
        cc.Class({
              ...
              Promise.all(
                t.map(function (t, n) {
                  ...
                  if ((h.init(s, e, i), c))
                    ...
                    0 == n &&
                      ((h.background.active = !0), (s.MenhGia.string = r)),
                      (h.text.string = r),
          ...
          onData: function (t) {
            void 0 === t.info ||
              ...
              ((this.isLoaded = !0),
              void 0 !== t.info.nhamang &&
                this.infoSet(t.info.nhamang, "nhamangList", "NhanhMang", !0),
              void 0 !== t.info.menhgia &&
                this.infoSet(t.info.menhgia, "menhgiaList", "MenhGia"))
          },
          onClickMua: function () {
      ...
      function (t, e, i) {
        ...
        cc.Class({
          ...
          addEvent: function () {
            ...
            this.editboxs))
              o.getHTMLElementByEditBox(this.editboxs[t]).addEventListener(
                "keydown",
                this.keyHandle,
                !1
              )
          ...
          removeEvent: function () {
            for (var t in this.editboxs)
              o.getHTMLElementByEditBox(this.editboxs[t]).removeEventListener(
                "keydown",
                this.keyHandle,
                !1
              )
          ...
          onClickMua: function () {
            parseInt(
              n.isEmpty(this.red.string) ||
                n.getOnlyNumberInString(this.red.string)
            ) < 1e3
              ? cc.RedT.inGame.notice.show({
                  title: "MUA XU",
                  text: "S\u1ed1 RED mua XU t\u1ed1i thi\u1ec3u l\xe0 1.000",
                })
              : n.isEmpty(this.captcha.string)
              ? cc.RedT.inGame.notice.show({
                  title: "MUA XU",
                  text: "Vui l\xf2ng nh\u1eadp ch\xednh x\xe1c m\xe3 x\xe1c nh\u1eadn.",
                })
        ...
        cc._RF.push(e, "84987GimdhLo67g4TdXG7dM", "subMenuControll"),
          cc.Class({
            ...
            onClickItem: function (t) {
              ...
              try {
                for (
                  var o, c = this.items[Symbol.iterator]();
                  !(e = (o = c.next()).done);
                  e = !0
                ) {
                  var s = o.value
