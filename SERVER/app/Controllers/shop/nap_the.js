  ...
  if (
    ...
    if (!validator.isLength(data.captcha, { min: 4, max: 4 })) {
      ...
      client.red({
        notice: {
          title: "ข้อผิดพลาด",
          text: "กรุณาเลือกสกุลเงินของบัตร...",
          load: false,
        },
      })
              ...
              function (err, cart) {
                if (cart !== null) {
                  client.red({
                    notice: {
                      title: "ความล้มเหลว",
                      text: "คุณเคยขอเติมเงินบัตรนี้มาก่อน.!!",
                      load: false,
                    },
                  })
                } else {
                    ...
                    function (error, create) {
                      if (!!create) {
                          ...
                          function (err, httpResponse, body) {
                            try {
                              ...
                              if (data["status"] == "1") {
                                ...
                                client.red({
                                  loading: { text: "อยู่ระหว่างดำเนินการ..." },
                                })
                              } else {
                                tab_NapThe
                                  .updateOne(
                              ...
                              client.red({
                                notice: {
                                  title: "ความล้มเหลว",
                                  text: "ระบบการโหลดบัตรอยู่ระหว่างการบำรุงรักษา กรุณากลับมาใหม่ภายหลัง.!",
                                  load: false,
                                },
                              })
                            }
                        ...
                        client.red({
                          notice: {
                            title: "ซ่อมบำรุง",
                            text: "ระบบเติมเงินอยู่ในระหว่างบำรุงรักษา กรุณาเก็บบัตรไว้และกลับมาใหม่ภายหลัง.",
                            load: false,
                          },
                        })
                      }
