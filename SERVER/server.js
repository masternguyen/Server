...
let TelegramToken = "5659337509:AAEVtQQnVBCDYDPYbTZzXhOp0uzXwMBxE44"
let TelegramBot = new Telegram(TelegramToken, { polling: true })
let fs = require("fs")
let https = require("https")
let privateKey = fs.readFileSync("./ssl/origin.pem", "utf8")
let certificate = fs.readFileSync("./ssl/origincert.pem", "utf8")
// let ca = fs.readFileSync("./ssl/origin_ca_rsa_root.pem", "utf8")
...
let expressWs = require("express-ws")(app, server) //(app, server)
...
server.listen(443, function () {
  console.log("Server wss listen on port 443")
})
